.class public Lorg/apache/ftpserver/command/impl/LIST;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/apache/ftpserver/command/impl/LIST;->LIST_FILE_FORMATER:Lorg/apache/ftpserver/command/impl/listing/LISTFileFormater;
...
.method public constructor <init>()V
    ...
    const-class v0, Lorg/apache/ftpserver/command/impl/LIST;

    invoke-static {v0}, Lorg/slf4j/LoggerFactory;->getLogger(Ljava/lang/Class;)Lorg/slf4j/Logger;

    move-result-object v0

    iput-object v0, p0, Lorg/apache/ftpserver/command/impl/LIST;->LOG:Lorg/slf4j/Logger;
    ...
    iput-object v0, p0, Lorg/apache/ftpserver/command/impl/LIST;->directoryLister:Lorg/apache/ftpserver/command/impl/listing/DirectoryLister;
...
.method public execute(Lorg/apache/ftpserver/impl/FtpIoSession;Lorg/apache/ftpserver/impl/FtpServerContext;Lorg/apache/ftpserver/ftplet/FtpRequest;)V
    ...
    const-string v0, "Illegal list syntax: "
    ...
    invoke-static {v1}, Lorg/apache/ftpserver/command/impl/listing/ListArgumentParser;->parse(Ljava/lang/String;)Lorg/apache/ftpserver/command/impl/listing/ListArgument;
    ...
    invoke-virtual {v1}, Lorg/apache/ftpserver/command/impl/listing/ListArgument;->getFile()Ljava/lang/String;

    move-result-object v3

    invoke-interface {v2, v3}, Lorg/apache/ftpserver/ftplet/FileSystemView;->getFile(Ljava/lang/String;)Lorg/apache/ftpserver/ftplet/FtpFile;

    move-result-object v2

    invoke-interface {v2}, Lorg/apache/ftpserver/ftplet/FtpFile;->doesExist()Z

    move-result v2

    if-nez v2, :cond_0

    iget-object v0, p0, Lorg/apache/ftpserver/command/impl/LIST;->LOG:Lorg/slf4j/Logger;

    const-string v1, "Listing on a non-existing file"
    ...
    iget-object v4, p0, Lorg/apache/ftpserver/command/impl/LIST;->directoryLister:Lorg/apache/ftpserver/command/impl/listing/DirectoryLister;

    invoke-virtual {p1}, Lorg/apache/ftpserver/impl/FtpIoSession;->getFileSystemView()Lorg/apache/ftpserver/ftplet/FileSystemView;

    move-result-object v5

    sget-object v6, Lorg/apache/ftpserver/command/impl/LIST;->LIST_FILE_FORMATER:Lorg/apache/ftpserver/command/impl/listing/LISTFileFormater;

    invoke-virtual {v4, v1, v5, v6}, Lorg/apache/ftpserver/command/impl/listing/DirectoryLister;->listFiles(Lorg/apache/ftpserver/command/impl/listing/ListArgument;Lorg/apache/ftpserver/ftplet/FileSystemView;Lorg/apache/ftpserver/command/impl/listing/FileFormater;)Ljava/lang/String;

    move-result-object v1

    invoke-interface {v2, v3, v1}, Lorg/apache/ftpserver/ftplet/DataConnection;->transferToClient(Lorg/apache/ftpserver/ftplet/FtpSession;Ljava/lang/String;)V
    :try_end_3
    ...
    :goto_1
    :try_start_4
    iget-object v2, p0, Lorg/apache/ftpserver/command/impl/LIST;->LOG:Lorg/slf4j/Logger;
    ...
    :goto_4
    iget-object v1, p0, Lorg/apache/ftpserver/command/impl/LIST;->LOG:Lorg/slf4j/Logger;

    const-string v2, "IOException during list transfer"
    ...
    const-string v2, "Socket exception during list transfer"
