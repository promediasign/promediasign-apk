...
.method public static HSL2RGB(DDDD)Ljava/awt/Color;
    ...
    invoke-direct {v4, v5, v6, v2, v0}, Ljava/awt/Color;-><init>(FFFF)V
...
.method public static applyColorTransform(Lorg/apache/poi/sl/usermodel/ColorStyle;)Ljava/awt/Color;
    ...
    :cond_1
    :goto_0
    sget-object p0, Lorg/apache/poi/sl/draw/DrawPaint;->TRANSPARENT:Ljava/awt/Color;
...
# virtual methods
.method public createLinearGradientPaint(Lorg/apache/poi/sl/usermodel/PaintStyle$GradientPaint;Ljava/awt/Graphics2D;)Ljava/awt/Paint;
    .locals 18
    ...
    invoke-static/range {v12 .. v17}, Ljava/awt/geom/AffineTransform;->getRotateInstance(DDD)Ljava/awt/geom/AffineTransform;
    ...
    invoke-direct {v12, v2, v3, v4, v5}, Ljava/awt/geom/Point2D$Double;-><init>(DD)V

    const/4 v2, 0x0

    invoke-virtual {v1, v12, v2}, Ljava/awt/geom/AffineTransform;->transform(Ljava/awt/geom/Point2D;Ljava/awt/geom/Point2D;)Ljava/awt/geom/Point2D;
    ...
    invoke-direct {v10, v8, v9, v4, v5}, Ljava/awt/geom/Point2D$Double;-><init>(DD)V

    invoke-virtual {v1, v10, v2}, Ljava/awt/geom/AffineTransform;->transform(Ljava/awt/geom/Point2D;Ljava/awt/geom/Point2D;)Ljava/awt/geom/Point2D;

    move-result-object v1

    invoke-virtual {v3, v1}, Ljava/awt/geom/Point2D;->equals(Ljava/lang/Object;)Z
    ...
    sget-object v9, Lorg/apache/poi/sl/draw/DrawPaint;->TRANSPARENT:Ljava/awt/Color;
    ...
    invoke-direct {v5, v3, v1, v2, v4}, Ljava/awt/LinearGradientPaint;-><init>(Ljava/awt/geom/Point2D;Ljava/awt/geom/Point2D;[F[Ljava/awt/Color;)V

    return-object v5
.end method

.method public createPathGradientPaint(Lorg/apache/poi/sl/usermodel/PaintStyle$GradientPaint;Ljava/awt/Graphics2D;)Ljava/awt/Paint;
    .locals 6
    ...
    invoke-static {v4}, Lorg/apache/poi/sl/draw/DrawPaint;->applyColorTransform(Lorg/apache/poi/sl/usermodel/ColorStyle;)Ljava/awt/Color;
    ...
    invoke-direct {p1, v0, p2}, Lorg/apache/poi/sl/draw/PathGradientPaint;-><init>([Ljava/awt/Color;[F)V

    return-object p1
.end method

.method public createRadialGradientPaint(Lorg/apache/poi/sl/usermodel/PaintStyle$GradientPaint;Ljava/awt/Graphics2D;)Ljava/awt/Paint;
    .locals 9
    ...
    invoke-direct {v0, v3, v4, v7, v8}, Ljava/awt/geom/Point2D$Double;-><init>(DD)V
    ...
    :cond_0
    new-instance p1, Ljava/awt/RadialGradientPaint;

    invoke-direct {p1, v0, p2, v1, v2}, Ljava/awt/RadialGradientPaint;-><init>(Ljava/awt/geom/Point2D;F[F[Ljava/awt/Color;)V

    return-object p1
.end method

.method public getGradientPaint(Lorg/apache/poi/sl/usermodel/PaintStyle$GradientPaint;Ljava/awt/Graphics2D;)Ljava/awt/Paint;
    .locals 2
...
.method public getPaint(Ljava/awt/Graphics2D;Lorg/apache/poi/sl/usermodel/PaintStyle;Lorg/apache/poi/sl/usermodel/PaintStyle$PaintModifier;)Ljava/awt/Paint;
    ...
    invoke-virtual {p0, p2, p1, p3}, Lorg/apache/poi/sl/draw/DrawPaint;->getSolidPaint(Lorg/apache/poi/sl/usermodel/PaintStyle$SolidPaint;Ljava/awt/Graphics2D;Lorg/apache/poi/sl/usermodel/PaintStyle$PaintModifier;)Ljava/awt/Paint;
    ...
    invoke-virtual {p0, p2, p1}, Lorg/apache/poi/sl/draw/DrawPaint;->getGradientPaint(Lorg/apache/poi/sl/usermodel/PaintStyle$GradientPaint;Ljava/awt/Graphics2D;)Ljava/awt/Paint;
    ...
    invoke-virtual {p0, p2, p1}, Lorg/apache/poi/sl/draw/DrawPaint;->getTexturePaint(Lorg/apache/poi/sl/usermodel/PaintStyle$TexturePaint;Ljava/awt/Graphics2D;)Ljava/awt/Paint;
...
.method public getSolidPaint(Lorg/apache/poi/sl/usermodel/PaintStyle$SolidPaint;Ljava/awt/Graphics2D;Lorg/apache/poi/sl/usermodel/PaintStyle$PaintModifier;)Ljava/awt/Paint;
    .locals 0
...
.method public getTexturePaint(Lorg/apache/poi/sl/usermodel/PaintStyle$TexturePaint;Ljava/awt/Graphics2D;)Ljava/awt/Paint;
    .locals 8
    ...
    invoke-static {p2, v4}, Lorg/apache/poi/sl/draw/DrawPictureShape;->getImageRenderer(Ljava/awt/Graphics2D;Ljava/lang/String;)Lorg/apache/poi/sl/draw/ImageRenderer;
    ...
    invoke-interface {p2, v2, v5}, Lorg/apache/poi/sl/draw/ImageRenderer;->loadImage(Ljava/io/InputStream;Ljava/lang/String;)V
    :try_end_0
    ...
    :cond_1
    iget-object v2, p0, Lorg/apache/poi/sl/draw/DrawPaint;->shape:Lorg/apache/poi/sl/usermodel/PlaceableShape;

    invoke-interface {v2}, Lorg/apache/poi/sl/usermodel/PlaceableShape;->getAnchor()Ljava/awt/geom/Rectangle2D;
    ...
    invoke-direct {p1, v5, v6}, Ljava/awt/Dimension;-><init>(II)V

    invoke-interface {p2, p1}, Lorg/apache/poi/sl/draw/ImageRenderer;->getImage(Ljava/awt/Dimension;)Ljava/awt/image/BufferedImage;
    ...
    :cond_2
    invoke-interface {p2}, Lorg/apache/poi/sl/draw/ImageRenderer;->getImage()Ljava/awt/image/BufferedImage;
    ...
    const-string v1, "Can\'t load image data"
    ...
    :cond_3
    new-instance p2, Ljava/awt/TexturePaint;

    invoke-direct {p2, p1, v2}, Ljava/awt/TexturePaint;-><init>(Ljava/awt/image/BufferedImage;Ljava/awt/geom/Rectangle2D;)V
    ...
    invoke-virtual {p2, v4, v2}, Lorg/apache/poi/util/POILogger;->log(I[Ljava/lang/Object;)V

    return-object v3
.end method

.method public snapToAnchor(Ljava/awt/geom/Point2D;Ljava/awt/geom/Rectangle2D;)V
    .locals 6
