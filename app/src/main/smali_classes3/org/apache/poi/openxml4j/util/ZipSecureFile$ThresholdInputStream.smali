...
.method public advance(I)V
    ...
    :cond_0
    iget-wide v2, p1, Lorg/apache/poi/openxml4j/util/ZipSecureFile$ThresholdInputStream;->counter:J

    :goto_0
    invoke-virtual {v1, v2, v3}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    const-string p1, "Limits: MAX_ENTRY_SIZE: "
    ...
    :cond_3
    iget-wide v3, v0, Lorg/apache/poi/openxml4j/util/ZipSecureFile$ThresholdInputStream;->counter:J
    ...
    iget-wide v5, p1, Lorg/apache/poi/openxml4j/util/ZipSecureFile$ThresholdInputStream;->counter:J
...
.method public closeEntry()V
    ...
    const-string v1, "underlying stream is not a ZipInputStream"
...
.method public unread(I)V
    ...
    const-string v0, "underlying stream is not a PushbackInputStream"
...
.method public unread([BII)V
    ...
    const-string p2, "underlying stream is not a PushbackInputStream"
