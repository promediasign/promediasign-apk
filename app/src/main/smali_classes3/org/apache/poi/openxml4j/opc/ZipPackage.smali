...
.method public constructor <init>()V
    ...
    const-string v3, "Could not parse ZipPackage"
...
.method public constructor <init>(Ljava/io/File;Lorg/apache/poi/openxml4j/opc/PackageAccess;)V
    ...
    const-string v0, "Error in zip file "

    const-string v1, " - falling back to stream processing (i.e. ignoring zip central directory)"
...
.method private static openZipEntrySourceStream(Ljava/io/File;)Lorg/apache/poi/openxml4j/util/ZipEntrySource;
    ...
    const-string v3, "Failed to read the file input stream from file: \'"

    .line 1
    invoke-static {p0, v3, v0}, Lch/qos/logback/core/joran/util/a;->i(Ljava/io/File;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v3, "Can\'t open the specified file input stream from file: \'"
...
.method public closeImpl()V
    ...
    const-string v2, "\' cannot be deleted ! Make sure that no other application use it."

    const-string v3, "The temporary file: \'"

    invoke-virtual {p0}, Lorg/apache/poi/openxml4j/opc/OPCPackage;->flush()V

    iget-object v4, p0, Lorg/apache/poi/openxml4j/opc/OPCPackage;->originalPackagePath:Ljava/lang/String;
    ...
    iget-object v5, p0, Lorg/apache/poi/openxml4j/opc/OPCPackage;->originalPackagePath:Ljava/lang/String;
    ...
    invoke-static {v4}, Lorg/apache/poi/openxml4j/opc/internal/FileHelper;->getDirectory(Ljava/io/File;)Ljava/io/File;

    move-result-object v5

    invoke-direct {p0, v5}, Lorg/apache/poi/openxml4j/opc/ZipPackage;->generateTempFileName(Ljava/io/File;)Ljava/lang/String;

    move-result-object v5

    const-string v6, ".tmp"

    invoke-static {v5, v6}, Lorg/apache/poi/util/TempFile;->createTempFile(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
    ...
    :try_start_0
    invoke-virtual {p0, v5}, Lorg/apache/poi/openxml4j/opc/OPCPackage;->save(Ljava/io/File;)V
    :try_end_0
    ...
    :try_start_1
    invoke-static {v5, v4}, Lorg/apache/poi/openxml4j/opc/internal/FileHelper;->copyFile(Ljava/io/File;Ljava/io/File;)V
    :try_end_1
    ...
    invoke-virtual {v5, v6, v1}, Lorg/apache/poi/util/POILogger;->log(I[Ljava/lang/Object;)V
...
.method public saveImpl(Ljava/io/OutputStream;)V
    ...
    const-string v3, "http://schemas.openxmlformats.org/package/2006/relationships/metadata/core-properties"

    invoke-virtual {p0}, Lorg/apache/poi/openxml4j/opc/OPCPackage;->throwExceptionIfReadOnly()V

    :try_start_0
    instance-of v4, p1, Ljava/util/zip/ZipOutputStream;
    ...
    invoke-virtual {p1, v1, v5}, Lorg/apache/poi/util/POILogger;->log(I[Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, v5, v6, v3, v7}, Lorg/apache/poi/openxml4j/opc/PackageRelationshipCollection;->addRelationship(Ljava/net/URI;Lorg/apache/poi/openxml4j/opc/TargetMode;Ljava/lang/String;Ljava/lang/String;)Lorg/apache/poi/openxml4j/opc/PackageRelationship;
    ...
    iget-object v3, p0, Lorg/apache/poi/openxml4j/opc/OPCPackage;->packageProperties:Lorg/apache/poi/openxml4j/opc/internal/PackagePropertiesPart;

    invoke-virtual {v3}, Lorg/apache/poi/openxml4j/opc/PackagePart;->getPartName()Lorg/apache/poi/openxml4j/opc/PackagePartName;

    move-result-object v3

    invoke-virtual {p1, v3, v2}, Lorg/apache/poi/openxml4j/opc/internal/ContentTypeManager;->addContentType(Lorg/apache/poi/openxml4j/opc/PackagePartName;Ljava/lang/String;)V
    ...
    const-string v3, "Save package relationships"

    aput-object v3, v2, v0

    invoke-virtual {p1, v1, v2}, Lorg/apache/poi/util/POILogger;->log(I[Ljava/lang/Object;)V
    ...
    invoke-static {v2, v3, v4}, Lorg/apache/poi/openxml4j/opc/internal/marshallers/ZipPartMarshaller;->marshallRelationshipPart(Lorg/apache/poi/openxml4j/opc/PackageRelationshipCollection;Lorg/apache/poi/openxml4j/opc/PackagePartName;Ljava/util/zip/ZipOutputStream;)Z

    new-array v2, v1, [Ljava/lang/Object;

    const-string v3, "Save content types part"
    ...
    invoke-virtual {p1, v4}, Lorg/apache/poi/openxml4j/opc/internal/ContentTypeManager;->save(Ljava/io/OutputStream;)Z
    ...
    invoke-static {v7}, Lorg/apache/poi/openxml4j/opc/internal/ZipHelper;->getZipItemNameFromOPCName(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v5, v1, v7}, Lorg/apache/poi/util/POILogger;->log(I[Ljava/lang/Object;)V

    iget-object v5, p0, Lorg/apache/poi/openxml4j/opc/OPCPackage;->partMarshallers:Ljava/util/Map;

    iget-object v6, v2, Lorg/apache/poi/openxml4j/opc/PackagePart;->_contentType:Lorg/apache/poi/openxml4j/opc/internal/ContentType;
    ...
    const-string v3, " failed to be saved in the stream with marshaller "
    ...
    invoke-interface {v5, v2, v4}, Lorg/apache/poi/openxml4j/opc/internal/PartMarshaller;->marshall(Lorg/apache/poi/openxml4j/opc/PackagePart;Ljava/io/OutputStream;)Z
