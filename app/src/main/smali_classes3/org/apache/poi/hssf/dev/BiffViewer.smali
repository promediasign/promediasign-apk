...
.method public static createRecords(Ljava/io/InputStream;Ljava/io/PrintWriter;Lorg/apache/poi/hssf/dev/BiffViewer$BiffRecordListener;Z)[Lorg/apache/poi/hssf/record/Record;
    ...
    sget-object v2, Lorg/apache/poi/hssf/dev/BiffViewer;->logger:Lorg/apache/poi/util/POILogger;
    ...
    const-string v4, " bytes and continuing"
    ...
    invoke-virtual {v2, p0, v4}, Lorg/apache/poi/util/POILogger;->log(I[Ljava/lang/Object;)V
...
.method public static getPOIFSInputStream(Lorg/apache/poi/poifs/filesystem/NPOIFSFileSystem;)Ljava/io/InputStream;
    .locals 1
...
.method private static hexDumpLine(Ljava/io/Writer;[BIIII)V
    ...
    sget-object v3, Lorg/apache/poi/hssf/dev/BiffViewer;->NEW_LINE_CHARS:[C
    ...
    :try_start_0
    invoke-static {v1, v4, p2, v3}, Lorg/apache/poi/hssf/dev/BiffViewer;->writeHex([CIII)V
    ...
    invoke-static {v1, p2, v3, v2}, Lorg/apache/poi/hssf/dev/BiffViewer;->writeHex([CIII)V
    ...
    invoke-static {v0, v1, p2}, Lorg/apache/poi/hssf/dev/BiffViewer;->arraycopy([C[CI)I
    ...
    invoke-static {p1, v1, p2}, Lorg/apache/poi/hssf/dev/BiffViewer;->arraycopy([C[CI)I

    move-result p1

    invoke-virtual {p0, v1, v4, p1}, Ljava/io/Writer;->write([CII)V
    :try_end_0
...
.method public static main([Ljava/lang/String;)V
    ...
    invoke-direct {v2, v3, v4}, Lorg/apache/poi/poifs/filesystem/NPOIFSFileSystem;-><init>(Ljava/io/File;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1

    :try_start_1
    invoke-static {v2}, Lorg/apache/poi/hssf/dev/BiffViewer;->getPOIFSInputStream(Lorg/apache/poi/poifs/filesystem/NPOIFSFileSystem;)Ljava/io/InputStream;
    ...
    invoke-static {p0, v5, v6, v3, v4}, Lorg/apache/poi/util/HexDump;->dump([BJLjava/io/OutputStream;I)V
    ...
    invoke-static/range {v4 .. v9}, Lorg/apache/poi/hssf/dev/BiffViewer;->runBiffViewer(Ljava/io/PrintWriter;Ljava/io/InputStream;ZZZZ)V
    :try_end_1
...
.method public static runBiffViewer(Ljava/io/PrintWriter;Ljava/io/InputStream;ZZZZ)V
    .locals 1
    ...
    :goto_0
    invoke-direct {v0, p3, p4, p5}, Lorg/apache/poi/hssf/dev/BiffViewer$BiffRecordListener;-><init>(Ljava/io/Writer;ZZ)V

    new-instance p3, Lorg/apache/poi/hssf/dev/BiffViewer$BiffDumpingStream;

    invoke-direct {p3, p1, v0}, Lorg/apache/poi/hssf/dev/BiffViewer$BiffDumpingStream;-><init>(Ljava/io/InputStream;Lorg/apache/poi/hssf/dev/BiffViewer$IBiffRecordListener;)V

    invoke-static {p3, p0, v0, p2}, Lorg/apache/poi/hssf/dev/BiffViewer;->createRecords(Ljava/io/InputStream;Ljava/io/PrintWriter;Lorg/apache/poi/hssf/dev/BiffViewer$BiffRecordListener;Z)[Lorg/apache/poi/hssf/record/Record;
