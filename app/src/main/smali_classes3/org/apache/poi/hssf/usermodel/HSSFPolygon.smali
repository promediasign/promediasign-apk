...
.method public setPoints([I[I)V
    ...
    sget-object p1, Lorg/apache/poi/hssf/usermodel/HSSFPolygon;->logger:Lorg/apache/poi/util/POILogger;
    ...
    invoke-virtual {p1, v5, p2}, Lorg/apache/poi/util/POILogger;->log(I[Ljava/lang/Object;)V
    ...
    sget-object v3, Lorg/apache/poi/hssf/usermodel/HSSFPolygon;->logger:Lorg/apache/poi/util/POILogger;

    new-array v4, v1, [Ljava/lang/Object;

    const-string v6, "HSSFPolygon must have at least one point"
    ...
    invoke-direct {v3, v4, v0, v5}, Lorg/apache/poi/ddf/EscherArrayProperty;-><init>(SZ[B)V

    array-length v4, p1

    add-int/2addr v4, v1

    invoke-virtual {v3, v4}, Lorg/apache/poi/ddf/EscherArrayProperty;->setNumberOfElementsInArray(I)V

    array-length v4, p1

    add-int/2addr v4, v1

    invoke-virtual {v3, v4}, Lorg/apache/poi/ddf/EscherArrayProperty;->setNumberOfElementsInMemory(I)V

    const v4, 0xfff0

    invoke-virtual {v3, v4}, Lorg/apache/poi/ddf/EscherArrayProperty;->setSizeOfElements(I)V
    ...
    invoke-static {v5, v0, v6}, Lorg/apache/poi/util/LittleEndian;->putShort([BIS)V

    aget v6, p2, v4

    int-to-short v6, v6

    invoke-static {v5, v2, v6}, Lorg/apache/poi/util/LittleEndian;->putShort([BIS)V

    invoke-virtual {v3, v4, v5}, Lorg/apache/poi/ddf/EscherArrayProperty;->setElement(I[B)V
    ...
    invoke-static {v5, v0, v7}, Lorg/apache/poi/util/LittleEndian;->putShort([BIS)V

    aget p2, p2, v0

    int-to-short p2, p2

    invoke-static {v5, v2, p2}, Lorg/apache/poi/util/LittleEndian;->putShort([BIS)V

    invoke-virtual {v3, v4, v5}, Lorg/apache/poi/ddf/EscherArrayProperty;->setElement(I[B)V

    invoke-virtual {p0, v3}, Lorg/apache/poi/hssf/usermodel/HSSFShape;->setPropertyValue(Lorg/apache/poi/ddf/EscherProperty;)V
    ...
    invoke-direct {p2, v3, v0, v4}, Lorg/apache/poi/ddf/EscherArrayProperty;-><init>(SZ[B)V

    invoke-virtual {p2, v2}, Lorg/apache/poi/ddf/EscherArrayProperty;->setSizeOfElements(I)V
    ...
    invoke-virtual {p2, v3}, Lorg/apache/poi/ddf/EscherArrayProperty;->setNumberOfElementsInArray(I)V
    ...
    invoke-virtual {p2, v3}, Lorg/apache/poi/ddf/EscherArrayProperty;->setNumberOfElementsInMemory(I)V

    new-array v3, v2, [B

    fill-array-data v3, :array_0

    invoke-virtual {p2, v0, v3}, Lorg/apache/poi/ddf/EscherArrayProperty;->setElement(I[B)V

    new-array v3, v2, [B

    fill-array-data v3, :array_1

    invoke-virtual {p2, v1, v3}, Lorg/apache/poi/ddf/EscherArrayProperty;->setElement(I[B)V
    ...
    invoke-virtual {p2, v4, v5}, Lorg/apache/poi/ddf/EscherArrayProperty;->setElement(I[B)V
    ...
    invoke-virtual {p2, v3, v4}, Lorg/apache/poi/ddf/EscherArrayProperty;->setElement(I[B)V
