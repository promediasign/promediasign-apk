...
.field private final tailRec:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/Integer;",
...
.method private static sid(Ljava/util/List;I)S
    ...
    check-cast p0, Lorg/apache/poi/hssf/record/RecordBase;

    instance-of p1, p0, Lorg/apache/poi/hssf/record/Record;
...
.method private writeDataIntoDrawingRecord([BII[BI)I
    ...
    new-instance v3, Lorg/apache/poi/hssf/record/ContinueRecord;

    invoke-direct {v3, v2}, Lorg/apache/poi/hssf/record/ContinueRecord;-><init>([B)V

    add-int v2, p3, p5

    invoke-virtual {v3, v2, p4}, Lorg/apache/poi/hssf/record/StandardRecord;->serialize(I[B)I
    ...
    invoke-static {p1, p2, v3, v0, v4}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    invoke-virtual {v2, v3}, Lorg/apache/poi/hssf/record/DrawingRecord;->setData([B)V

    add-int v3, p3, p5

    invoke-virtual {v2, v3, p4}, Lorg/apache/poi/hssf/record/StandardRecord;->serialize(I[B)I
...
.method public getRecordSize()I
    ...
    invoke-virtual {v3}, Lorg/apache/poi/hssf/record/StandardRecord;->getRecordSize()I
    ...
    :cond_6
    invoke-static {v2, v1, v4, v6}, LA/g;->a(IIII)I
...
.method public serialize(I[B)I
    ...
    invoke-static {v9, v0, v1, v2, v8}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    :cond_4
    iget-object v0, v6, Lorg/apache/poi/hssf/record/EscherAggregate;->tailRec:Ljava/util/Map;
    ...
    invoke-virtual {v2, v1, v7}, Lorg/apache/poi/hssf/record/StandardRecord;->serialize(I[B)I
    ...
    const-string v1, " bytes written but getRecordSize() reports "
