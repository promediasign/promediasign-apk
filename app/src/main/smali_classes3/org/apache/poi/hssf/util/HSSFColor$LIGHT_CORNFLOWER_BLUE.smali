.class public Lorg/apache/poi/hssf/util/HSSFColor$LIGHT_CORNFLOWER_BLUE;
...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lorg/apache/poi/hssf/util/HSSFColor$HSSFColorPredefined;->LIGHT_CORNFLOWER_BLUE:Lorg/apache/poi/hssf/util/HSSFColor$HSSFColorPredefined;

    sput-object v0, Lorg/apache/poi/hssf/util/HSSFColor$LIGHT_CORNFLOWER_BLUE;->ref:Lorg/apache/poi/hssf/util/HSSFColor$HSSFColorPredefined;

    invoke-virtual {v0}, Lorg/apache/poi/hssf/util/HSSFColor$HSSFColorPredefined;->getIndex()S

    move-result v1

    sput-short v1, Lorg/apache/poi/hssf/util/HSSFColor$LIGHT_CORNFLOWER_BLUE;->index:S

    invoke-virtual {v0}, Lorg/apache/poi/hssf/util/HSSFColor$HSSFColorPredefined;->getIndex2()S

    move-result v1

    sput v1, Lorg/apache/poi/hssf/util/HSSFColor$LIGHT_CORNFLOWER_BLUE;->index2:I

    invoke-virtual {v0}, Lorg/apache/poi/hssf/util/HSSFColor$HSSFColorPredefined;->getTriplet()[S

    move-result-object v1

    sput-object v1, Lorg/apache/poi/hssf/util/HSSFColor$LIGHT_CORNFLOWER_BLUE;->triplet:[S

    invoke-virtual {v0}, Lorg/apache/poi/hssf/util/HSSFColor$HSSFColorPredefined;->getHexString()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lorg/apache/poi/hssf/util/HSSFColor$LIGHT_CORNFLOWER_BLUE;->hexString:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    sget-object v0, Lorg/apache/poi/hssf/util/HSSFColor$LIGHT_CORNFLOWER_BLUE;->ref:Lorg/apache/poi/hssf/util/HSSFColor$HSSFColorPredefined;
