...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lorg/apache/poi/poifs/filesystem/Ole10Native$EncodingMode;

    const-string v3, "unparsed"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lorg/apache/poi/poifs/filesystem/Ole10Native$EncodingMode;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lorg/apache/poi/poifs/filesystem/Ole10Native$EncodingMode;->unparsed:Lorg/apache/poi/poifs/filesystem/Ole10Native$EncodingMode;

    new-instance v3, Lorg/apache/poi/poifs/filesystem/Ole10Native$EncodingMode;

    const-string v5, "compact"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lorg/apache/poi/poifs/filesystem/Ole10Native$EncodingMode;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lorg/apache/poi/poifs/filesystem/Ole10Native$EncodingMode;->compact:Lorg/apache/poi/poifs/filesystem/Ole10Native$EncodingMode;

    const/4 v5, 0x3

    new-array v5, v5, [Lorg/apache/poi/poifs/filesystem/Ole10Native$EncodingMode;
    ...
    sput-object v5, Lorg/apache/poi/poifs/filesystem/Ole10Native$EncodingMode;->$VALUES:[Lorg/apache/poi/poifs/filesystem/Ole10Native$EncodingMode;
...
.method public static valueOf(Ljava/lang/String;)Lorg/apache/poi/poifs/filesystem/Ole10Native$EncodingMode;
    ...
    check-cast p0, Lorg/apache/poi/poifs/filesystem/Ole10Native$EncodingMode;
