...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v3, v4}, Lorg/apache/poi/ss/util/CellRangeAddressBase$CellPosition;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v3, v5, v6}, Lorg/apache/poi/ss/util/CellRangeAddressBase$CellPosition;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lorg/apache/poi/ss/util/CellRangeAddressBase$CellPosition;->LEFT:Lorg/apache/poi/ss/util/CellRangeAddressBase$CellPosition;

    new-instance v5, Lorg/apache/poi/ss/util/CellRangeAddressBase$CellPosition;

    const-string v7, "RIGHT"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lorg/apache/poi/ss/util/CellRangeAddressBase$CellPosition;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lorg/apache/poi/ss/util/CellRangeAddressBase$CellPosition;->RIGHT:Lorg/apache/poi/ss/util/CellRangeAddressBase$CellPosition;

    new-instance v7, Lorg/apache/poi/ss/util/CellRangeAddressBase$CellPosition;

    const-string v9, "INSIDE"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lorg/apache/poi/ss/util/CellRangeAddressBase$CellPosition;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lorg/apache/poi/ss/util/CellRangeAddressBase$CellPosition;->INSIDE:Lorg/apache/poi/ss/util/CellRangeAddressBase$CellPosition;

    const/4 v9, 0x5

    new-array v9, v9, [Lorg/apache/poi/ss/util/CellRangeAddressBase$CellPosition;
    ...
    sput-object v9, Lorg/apache/poi/ss/util/CellRangeAddressBase$CellPosition;->$VALUES:[Lorg/apache/poi/ss/util/CellRangeAddressBase$CellPosition;
