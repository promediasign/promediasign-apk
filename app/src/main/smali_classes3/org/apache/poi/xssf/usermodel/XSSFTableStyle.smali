...
.method public constructor <init>(ILorg/openxmlformats/schemas/spreadsheetml/x2006/main/CTDxfs;Lorg/openxmlformats/schemas/spreadsheetml/x2006/main/CTTableStyle;Lorg/apache/poi/xssf/usermodel/IndexedColorMap;)V
    ...
    iput-object v1, p0, Lorg/apache/poi/xssf/usermodel/XSSFTableStyle;->elementMap:Ljava/util/Map;

    invoke-interface {p3}, Lorg/openxmlformats/schemas/spreadsheetml/x2006/main/CTTableStyle;->getName()Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Lorg/apache/poi/xssf/usermodel/XSSFTableStyle;->name:Ljava/lang/String;
    ...
    const-string v1, "declare namespace x=\'http://schemas.openxmlformats.org/spreadsheetml/2006/main\' .//x:dxf | .//dxf"

    invoke-interface {p2, v1}, Lorg/apache/xmlbeans/XmlCursor;->selectPath(Ljava/lang/String;)V
    ...
    :cond_1
    :try_start_0
    instance-of v2, v1, Lorg/openxmlformats/schemas/spreadsheetml/x2006/main/CTDxf;

    if-eqz v2, :cond_2

    check-cast v1, Lorg/openxmlformats/schemas/spreadsheetml/x2006/main/CTDxf;
    ...
    :cond_2
    invoke-interface {v1}, Lorg/apache/xmlbeans/XmlTokenSource;->newXMLStreamReader()Lorg/apache/poi/javax/xml/stream/XMLStreamReader;
    ...
    invoke-static {v1, v2}, Lorg/openxmlformats/schemas/spreadsheetml/x2006/main/CTDxf$Factory;->parse(Lorg/apache/poi/javax/xml/stream/XMLStreamReader;Lorg/apache/xmlbeans/XmlOptions;)Lorg/openxmlformats/schemas/spreadsheetml/x2006/main/CTDxf;
    ...
    const-string v4, "Error parsing XSSFTableStyle"
    ...
    invoke-static {v1}, Lorg/apache/poi/ss/usermodel/TableStyleType;->valueOf(Ljava/lang/String;)Lorg/apache/poi/ss/usermodel/TableStyleType;
    ...
    new-instance v3, Lorg/apache/poi/xssf/usermodel/XSSFDxfStyleProvider;

    invoke-direct {v3, v2, p3, p4}, Lorg/apache/poi/xssf/usermodel/XSSFDxfStyleProvider;-><init>(Lorg/openxmlformats/schemas/spreadsheetml/x2006/main/CTDxf;ILorg/apache/poi/xssf/usermodel/IndexedColorMap;)V
