...
.method private addShapes(Lorg/apache/xmlbeans/XmlCursor;Ljava/util/List;)V
    ...
    instance-of v3, v2, Lorg/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/CTMarker;
    ...
    :cond_2
    instance-of v3, v2, Lorg/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/CTPicture;

    if-eqz v3, :cond_3

    new-instance v3, Lorg/apache/poi/xssf/usermodel/XSSFPicture;

    move-object v4, v2

    check-cast v4, Lorg/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/CTPicture;

    invoke-direct {v3, p0, v4}, Lorg/apache/poi/xssf/usermodel/XSSFPicture;-><init>(Lorg/apache/poi/xssf/usermodel/XSSFDrawing;Lorg/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/CTPicture;)V
    ...
    :cond_3
    instance-of v3, v2, Lorg/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/CTConnector;

    if-eqz v3, :cond_4

    new-instance v3, Lorg/apache/poi/xssf/usermodel/XSSFConnector;

    move-object v4, v2

    check-cast v4, Lorg/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/CTConnector;

    invoke-direct {v3, p0, v4}, Lorg/apache/poi/xssf/usermodel/XSSFConnector;-><init>(Lorg/apache/poi/xssf/usermodel/XSSFDrawing;Lorg/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/CTConnector;)V

    goto :goto_0

    :cond_4
    instance-of v3, v2, Lorg/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/CTShape;

    if-eqz v3, :cond_6

    invoke-direct {p0, v2}, Lorg/apache/poi/xssf/usermodel/XSSFDrawing;->hasOleLink(Lorg/apache/xmlbeans/XmlObject;)Z

    move-result v3

    if-eqz v3, :cond_5

    new-instance v3, Lorg/apache/poi/xssf/usermodel/XSSFObjectData;

    move-object v4, v2

    check-cast v4, Lorg/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/CTShape;

    invoke-direct {v3, p0, v4}, Lorg/apache/poi/xssf/usermodel/XSSFObjectData;-><init>(Lorg/apache/poi/xssf/usermodel/XSSFDrawing;Lorg/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/CTShape;)V

    goto :goto_0

    :cond_5
    new-instance v3, Lorg/apache/poi/xssf/usermodel/XSSFSimpleShape;

    move-object v4, v2

    check-cast v4, Lorg/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/CTShape;

    invoke-direct {v3, p0, v4}, Lorg/apache/poi/xssf/usermodel/XSSFSimpleShape;-><init>(Lorg/apache/poi/xssf/usermodel/XSSFDrawing;Lorg/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/CTShape;)V

    goto :goto_0

    :cond_6
    instance-of v3, v2, Lorg/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/CTGraphicalObjectFrame;
    ...
    check-cast v4, Lorg/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/CTGraphicalObjectFrame;

    invoke-direct {v3, p0, v4}, Lorg/apache/poi/xssf/usermodel/XSSFGraphicFrame;-><init>(Lorg/apache/poi/xssf/usermodel/XSSFDrawing;Lorg/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/CTGraphicalObjectFrame;)V

    goto :goto_0

    :cond_7
    instance-of v3, v2, Lorg/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/CTGroupShape;

    if-eqz v3, :cond_8

    new-instance v3, Lorg/apache/poi/xssf/usermodel/XSSFShapeGroup;

    move-object v4, v2

    check-cast v4, Lorg/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/CTGroupShape;

    invoke-direct {v3, p0, v4}, Lorg/apache/poi/xssf/usermodel/XSSFShapeGroup;-><init>(Lorg/apache/poi/xssf/usermodel/XSSFDrawing;Lorg/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/CTGroupShape;)V

    :goto_0
    invoke-direct {p0, v2}, Lorg/apache/poi/xssf/usermodel/XSSFDrawing;->getAnchorFromParent(Lorg/apache/xmlbeans/XmlObject;)Lorg/apache/poi/xssf/usermodel/XSSFAnchor;

    move-result-object v2

    iput-object v2, v3, Lorg/apache/poi/xssf/usermodel/XSSFShape;->anchor:Lorg/apache/poi/xssf/usermodel/XSSFAnchor;
    ...
    :cond_8
    instance-of v2, v2, Lorg/apache/xmlbeans/impl/values/XmlAnyTypeImpl;

    if-eqz v2, :cond_c

    sget-object v2, Lorg/apache/poi/xssf/usermodel/XSSFDrawing;->LOG:Lorg/apache/poi/util/POILogger;

    new-array v3, v1, [Ljava/lang/Object;

    const-string v4, "trying to parse AlternateContent, this unlinks the returned Shapes from the underlying xml content, so those shapes can\'t be used to modify the drawing, i.e. modifications will be ignored!"
    ...
    invoke-static {v3}, Lorg/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/CTDrawing$Factory;->parse(Lorg/apache/poi/javax/xml/stream/XMLStreamReader;)Lorg/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/CTDrawing;
    ...
    invoke-direct {p0, v2, p2}, Lorg/apache/poi/xssf/usermodel/XSSFDrawing;->addShapes(Lorg/apache/xmlbeans/XmlCursor;Ljava/util/List;)V
    :try_end_1
    ...
    const-string v7, "unable to parse CTDrawing in alternate content."
...
.method private hasOleLink(Lorg/apache/xmlbeans/XmlObject;)Z
    ...
    const-string v2, "{63B3BB69-23CF-44E3-9099-C40C66FF867C}"
...
.method private newShapeId()J
    ...
    invoke-interface {v0}, Lorg/openxmlformats/schemas/drawingml/x2006/spreadsheetDrawing/CTDrawing;->sizeOfTwoCellAnchorArray()I
...
.method public addPictureReference(I)Lorg/apache/poi/openxml4j/opc/PackageRelationship;
    ...
    sget-object v1, Lorg/apache/poi/xssf/usermodel/XSSFRelation;->IMAGES:Lorg/apache/poi/xssf/usermodel/XSSFRelation;

    invoke-virtual {p0, p1, v1, v0}, Lorg/apache/poi/POIXMLDocumentPart;->addRelation(Ljava/lang/String;Lorg/apache/poi/POIXMLRelation;Lorg/apache/poi/POIXMLDocumentPart;)Lorg/apache/poi/POIXMLDocumentPart$RelationPart;
...
.method public createCellComment(Lorg/apache/poi/ss/usermodel/ClientAnchor;)Lorg/apache/poi/xssf/usermodel/XSSFComment;
    ...
    invoke-direct {v0, v3, p1}, Lorg/apache/poi/ss/util/CellAddress;-><init>(II)V

    invoke-virtual {v2, v0}, Lorg/apache/poi/xssf/model/CommentsTable;->findCellComment(Lorg/apache/poi/ss/util/CellAddress;)Lorg/apache/poi/xssf/usermodel/XSSFComment;
    ...
    invoke-virtual {v2, v0}, Lorg/apache/poi/xssf/model/CommentsTable;->newComment(Lorg/apache/poi/ss/util/CellAddress;)Lorg/openxmlformats/schemas/spreadsheetml/x2006/main/CTComment;

    move-result-object v0

    invoke-direct {p1, v2, v0, v1}, Lorg/apache/poi/xssf/usermodel/XSSFComment;-><init>(Lorg/apache/poi/xssf/model/CommentsTable;Lorg/openxmlformats/schemas/spreadsheetml/x2006/main/CTComment;Lcom/microsoft/schemas/vml/CTShape;)V
...
.method public createObjectData(Lorg/apache/poi/ss/usermodel/ClientAnchor;II)Lorg/apache/poi/xssf/usermodel/XSSFObjectData;
    ...
    .line 2
    const-string v0, "/xl/embeddings/oleObject"
    ...
    invoke-virtual {v4, v3}, Lorg/apache/poi/xssf/usermodel/XSSFWorkbook;->getSheetIndex(Lorg/apache/poi/ss/usermodel/Sheet;)I
    ...
    invoke-virtual {v2, p2, v0, v5}, Lorg/apache/poi/openxml4j/opc/PackagePart;->addRelationship(Lorg/apache/poi/openxml4j/opc/PackagePartName;Lorg/apache/poi/openxml4j/opc/TargetMode;Ljava/lang/String;)Lorg/apache/poi/openxml4j/opc/PackageRelationship;
    ...
    invoke-virtual {v2, p3, v0, v5}, Lorg/apache/poi/openxml4j/opc/PackagePart;->addRelationship(Lorg/apache/poi/openxml4j/opc/PackagePartName;Lorg/apache/poi/openxml4j/opc/TargetMode;Ljava/lang/String;)Lorg/apache/poi/openxml4j/opc/PackageRelationship;
    ...
    invoke-virtual {v6, p3, v0, v5}, Lorg/apache/poi/openxml4j/opc/PackagePart;->addRelationship(Lorg/apache/poi/openxml4j/opc/PackagePartName;Lorg/apache/poi/openxml4j/opc/TargetMode;Ljava/lang/String;)Lorg/apache/poi/openxml4j/opc/PackageRelationship;
    ...
    invoke-interface {v0, v1}, Lorg/openxmlformats/schemas/spreadsheetml/x2006/main/CTOleObject;->setProgId(Ljava/lang/String;)V

    invoke-interface {v0, v3, v4}, Lorg/openxmlformats/schemas/spreadsheetml/x2006/main/CTOleObject;->setShapeId(J)V
    ...
    invoke-interface {p2, v0, v1}, Lorg/apache/xmlbeans/XmlCursor;->beginElement(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {p2, v5, v0, v2}, Lorg/apache/xmlbeans/XmlCursor;->insertAttributeWithValue(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "defaultSize"

    const-string v2, "0"

    invoke-interface {p2, v0, v2}, Lorg/apache/xmlbeans/XmlCursor;->insertAttributeWithValue(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v2, p2}, Lorg/apache/xmlbeans/XmlCursor;->copyXmlContents(Lorg/apache/xmlbeans/XmlCursor;)Z
    ...
    invoke-direct {v2, v1, v5}, Lorg/apache/poi/javax/xml/namespace/QName;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-interface {p2, v2}, Lorg/apache/xmlbeans/XmlCursor;->setName(Lorg/apache/poi/javax/xml/namespace/QName;)V
    ...
    invoke-interface {p3, v3, v4}, Lorg/openxmlformats/schemas/drawingml/x2006/main/CTNonVisualDrawingProps;->setId(J)V
    ...
    iput-object p1, p3, Lorg/apache/poi/xssf/usermodel/XSSFShape;->anchor:Lorg/apache/poi/xssf/usermodel/XSSFAnchor;
