...
.method private createAttribute(Lorg/w3c/dom/Document;Lorg/w3c/dom/Node;Ljava/lang/String;)Lorg/w3c/dom/Node;
    ...
    invoke-interface {p2, p3}, Lorg/w3c/dom/NamedNodeMap;->getNamedItem(Ljava/lang/String;)Lorg/w3c/dom/Node;
    ...
    invoke-interface {p1, v0, p3}, Lorg/w3c/dom/Document;->createAttributeNS(Ljava/lang/String;Ljava/lang/String;)Lorg/w3c/dom/Attr;

    move-result-object v0

    invoke-interface {p2, v0}, Lorg/w3c/dom/NamedNodeMap;->setNamedItem(Lorg/w3c/dom/Node;)Lorg/w3c/dom/Node;
...
.method private getComplexTypeForElement(Ljava/lang/String;Lorg/w3c/dom/Node;Lorg/w3c/dom/Node;)Lorg/w3c/dom/Node;
    ...
    invoke-direct {p0, p3, p1}, Lorg/apache/poi/xssf/extractor/XSSFExportToXml;->getComplexTypeNameFromChildren(Lorg/w3c/dom/Node;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, p2, v0, p1}, Lorg/apache/poi/xssf/extractor/XSSFExportToXml;->getComplexTypeNodeFromSchemaChildren(Lorg/w3c/dom/Node;Lorg/w3c/dom/Node;Ljava/lang/String;)Lorg/w3c/dom/Node;
...
.method private isValid(Lorg/w3c/dom/Document;)Z
    ...
    invoke-static {v2}, Ljavax/xml/validation/SchemaFactory;->newInstance(Ljava/lang/String;)Ljavax/xml/validation/SchemaFactory;
    ...
    invoke-virtual {v2}, Ljavax/xml/validation/Schema;->newValidator()Ljavax/xml/validation/Validator;
    ...
    invoke-virtual {v2, v3}, Ljavax/xml/validation/Validator;->validate(Ljavax/xml/transform/Source;)V
    :try_end_0
    ...
    const-string v4, "document is not valid"
...
.method private mapCellOnNode(Lorg/apache/poi/xssf/usermodel/XSSFCell;Lorg/w3c/dom/Node;)V
    ...
    sget-object v0, Lorg/apache/poi/xssf/extractor/XSSFExportToXml$1;->$SwitchMap$org$apache$poi$ss$usermodel$CellType:[I
    ...
    :goto_2
    instance-of p1, p2, Lorg/w3c/dom/Element;

    if-eqz p1, :cond_8

    check-cast p2, Lorg/w3c/dom/Element;

    invoke-interface {p2, v2}, Lorg/w3c/dom/Node;->setTextContent(Ljava/lang/String;)V

    goto :goto_3

    :cond_8
    invoke-interface {p2, v2}, Lorg/w3c/dom/Node;->setNodeValue(Ljava/lang/String;)V
...
.method public compare(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-direct {p0, v5, v0, v4}, Lorg/apache/poi/xssf/extractor/XSSFExportToXml;->getComplexTypeForElement(Ljava/lang/String;Lorg/w3c/dom/Node;Lorg/w3c/dom/Node;)Lorg/w3c/dom/Node;
    ...
    :cond_1
    invoke-direct {p0, v5, v4}, Lorg/apache/poi/xssf/extractor/XSSFExportToXml;->indexOfElementInComplexType(Ljava/lang/String;Lorg/w3c/dom/Node;)I
...
.method public exportToXML(Ljava/io/OutputStream;Ljava/lang/String;Z)V
    ...
    check-cast v3, Lorg/apache/poi/xssf/usermodel/helpers/XSSFSingleXmlCell;
    ...
    invoke-virtual {v3}, Lorg/apache/poi/xssf/usermodel/helpers/XSSFSingleXmlCell;->getReferencedCell()Lorg/apache/poi/xssf/usermodel/XSSFCell;
    ...
    invoke-direct {v0, v2, v10, v4, v9}, Lorg/apache/poi/xssf/extractor/XSSFExportToXml;->getNodeByXPath(Ljava/lang/String;Lorg/w3c/dom/Node;Lorg/w3c/dom/Document;Z)Lorg/w3c/dom/Node;

    move-result-object v2

    invoke-direct {v0, v3, v2}, Lorg/apache/poi/xssf/extractor/XSSFExportToXml;->mapCellOnNode(Lorg/apache/poi/xssf/usermodel/XSSFCell;Lorg/w3c/dom/Node;)V
    ...
    invoke-virtual {v8}, Lorg/apache/poi/xssf/usermodel/XSSFTable;->getCTTable()Lorg/openxmlformats/schemas/spreadsheetml/x2006/main/CTTable;
    ...
    invoke-virtual {v12}, Lorg/apache/poi/ss/util/CellReference;->getRow()I
    ...
    invoke-virtual {v3, v10}, Lorg/apache/poi/xssf/usermodel/XSSFSheet;->getRow(I)Lorg/apache/poi/xssf/usermodel/XSSFRow;
    ...
    invoke-direct {v0, v14, v15, v4, v11}, Lorg/apache/poi/xssf/extractor/XSSFExportToXml;->getNodeByXPath(Ljava/lang/String;Lorg/w3c/dom/Node;Lorg/w3c/dom/Document;Z)Lorg/w3c/dom/Node;
    ...
    invoke-virtual {v13, v11}, Lorg/apache/poi/xssf/usermodel/XSSFRow;->getCell(I)Lorg/apache/poi/xssf/usermodel/XSSFCell;
    ...
    new-instance v3, Lorg/apache/poi/xssf/usermodel/helpers/XSSFXmlColumnPr;
    ...
    invoke-direct {v3, v8, v1, v2}, Lorg/apache/poi/xssf/usermodel/helpers/XSSFXmlColumnPr;-><init>(Lorg/apache/poi/xssf/usermodel/XSSFTable;Lorg/openxmlformats/schemas/spreadsheetml/x2006/main/CTTableColumn;Lorg/openxmlformats/schemas/spreadsheetml/x2006/main/CTXmlColumnPr;)V

    invoke-virtual {v3}, Lorg/apache/poi/xssf/usermodel/helpers/XSSFXmlColumnPr;->getLocalXPath()Ljava/lang/String;

    move-result-object v1

    const/4 v2, 0x0

    invoke-direct {v0, v1, v14, v4, v2}, Lorg/apache/poi/xssf/extractor/XSSFExportToXml;->getNodeByXPath(Ljava/lang/String;Lorg/w3c/dom/Node;Lorg/w3c/dom/Document;Z)Lorg/w3c/dom/Node;

    move-result-object v1

    invoke-direct {v0, v9, v1}, Lorg/apache/poi/xssf/extractor/XSSFExportToXml;->mapCellOnNode(Lorg/apache/poi/xssf/usermodel/XSSFCell;Lorg/w3c/dom/Node;)V
