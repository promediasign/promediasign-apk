...
.method public static buildShapes(Lorg/openxmlformats/schemas/presentationml/x2006/main/CTGroupShape;Lorg/apache/poi/xslf/usermodel/XSLFSheet;)Ljava/util/List;
    ...
    instance-of v3, v2, Lorg/openxmlformats/schemas/presentationml/x2006/main/CTShape;

    if-eqz v3, :cond_0

    check-cast v2, Lorg/openxmlformats/schemas/presentationml/x2006/main/CTShape;

    invoke-static {v2, p1}, Lorg/apache/poi/xslf/usermodel/XSLFAutoShape;->create(Lorg/openxmlformats/schemas/presentationml/x2006/main/CTShape;Lorg/apache/poi/xslf/usermodel/XSLFSheet;)Lorg/apache/poi/xslf/usermodel/XSLFAutoShape;
    ...
    :cond_0
    instance-of v3, v2, Lorg/openxmlformats/schemas/presentationml/x2006/main/CTGroupShape;

    if-eqz v3, :cond_1

    new-instance v3, Lorg/apache/poi/xslf/usermodel/XSLFGroupShape;

    check-cast v2, Lorg/openxmlformats/schemas/presentationml/x2006/main/CTGroupShape;

    invoke-direct {v3, v2, p1}, Lorg/apache/poi/xslf/usermodel/XSLFGroupShape;-><init>(Lorg/openxmlformats/schemas/presentationml/x2006/main/CTGroupShape;Lorg/apache/poi/xslf/usermodel/XSLFSheet;)V
    ...
    :cond_1
    instance-of v3, v2, Lorg/openxmlformats/schemas/presentationml/x2006/main/CTConnector;

    if-eqz v3, :cond_2

    new-instance v3, Lorg/apache/poi/xslf/usermodel/XSLFConnectorShape;

    check-cast v2, Lorg/openxmlformats/schemas/presentationml/x2006/main/CTConnector;

    invoke-direct {v3, v2, p1}, Lorg/apache/poi/xslf/usermodel/XSLFConnectorShape;-><init>(Lorg/openxmlformats/schemas/presentationml/x2006/main/CTConnector;Lorg/apache/poi/xslf/usermodel/XSLFSheet;)V

    goto :goto_2

    :cond_2
    instance-of v3, v2, Lorg/openxmlformats/schemas/presentationml/x2006/main/CTPicture;

    if-eqz v3, :cond_3

    new-instance v3, Lorg/apache/poi/xslf/usermodel/XSLFPictureShape;

    check-cast v2, Lorg/openxmlformats/schemas/presentationml/x2006/main/CTPicture;

    invoke-direct {v3, v2, p1}, Lorg/apache/poi/xslf/usermodel/XSLFPictureShape;-><init>(Lorg/openxmlformats/schemas/presentationml/x2006/main/CTPicture;Lorg/apache/poi/xslf/usermodel/XSLFSheet;)V

    goto :goto_2

    :cond_3
    instance-of v3, v2, Lorg/openxmlformats/schemas/presentationml/x2006/main/CTGraphicalObjectFrame;

    if-eqz v3, :cond_4

    check-cast v2, Lorg/openxmlformats/schemas/presentationml/x2006/main/CTGraphicalObjectFrame;

    invoke-static {v2, p1}, Lorg/apache/poi/xslf/usermodel/XSLFGraphicFrame;->create(Lorg/openxmlformats/schemas/presentationml/x2006/main/CTGraphicalObjectFrame;Lorg/apache/poi/xslf/usermodel/XSLFSheet;)Lorg/apache/poi/xslf/usermodel/XSLFGraphicFrame;
    ...
    invoke-interface {p0, v2, v3}, Lorg/apache/xmlbeans/XmlCursor;->toChild(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {v2}, Lorg/openxmlformats/schemas/presentationml/x2006/main/CTGroupShape$Factory;->parse(Lorg/apache/poi/javax/xml/stream/XMLStreamReader;)Lorg/openxmlformats/schemas/presentationml/x2006/main/CTGroupShape;

    move-result-object v2

    invoke-static {v2, p1}, Lorg/apache/poi/xslf/usermodel/XSLFSheet;->buildShapes(Lorg/openxmlformats/schemas/presentationml/x2006/main/CTGroupShape;Lorg/apache/poi/xslf/usermodel/XSLFSheet;)Ljava/util/List;
    ...
    :try_start_2
    sget-object v3, Lorg/apache/poi/xslf/usermodel/XSLFSheet;->LOG:Lorg/apache/poi/util/POILogger;

    const/4 v4, 0x2

    new-array v4, v4, [Ljava/lang/Object;

    const-string v5, "unparsable alternate content"
...
.method public createPicture(Lorg/apache/poi/sl/usermodel/PictureData;)Lorg/apache/poi/xslf/usermodel/XSLFPictureShape;
    ...
    invoke-direct {v1, p1}, Lorg/apache/poi/xslf/usermodel/XSLFPictureData;-><init>(Lorg/apache/poi/openxml4j/opc/PackagePart;)V
...
.method public getPlaceholder(Lorg/openxmlformats/schemas/presentationml/x2006/main/CTPlaceholder;)Lorg/apache/poi/xslf/usermodel/XSLFSimpleShape;
    ...
    invoke-virtual {p0, v1}, Lorg/apache/poi/xslf/usermodel/XSLFSheet;->getPlaceholderById(I)Lorg/apache/poi/xslf/usermodel/XSLFSimpleShape;
...
.method public initPlaceholders()V
    ...
    iget-object v3, p0, Lorg/apache/poi/xslf/usermodel/XSLFSheet;->_placeholderByIdMap:Ljava/util/Map;
