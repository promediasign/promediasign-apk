...
.method public copy(Lorg/apache/poi/xslf/usermodel/XSLFShape;)V
    ...
    instance-of v3, v2, Lorg/apache/poi/xslf/usermodel/XSLFTextBox;
    ...
    :cond_1
    instance-of v3, v2, Lorg/apache/poi/xslf/usermodel/XSLFAutoShape;
    ...
    :cond_2
    instance-of v3, v2, Lorg/apache/poi/xslf/usermodel/XSLFConnectorShape;
    ...
    :cond_3
    instance-of v3, v2, Lorg/apache/poi/xslf/usermodel/XSLFFreeformShape;
    ...
    :cond_4
    instance-of v3, v2, Lorg/apache/poi/xslf/usermodel/XSLFPictureShape;

    if-eqz v3, :cond_5

    move-object v3, v2

    check-cast v3, Lorg/apache/poi/xslf/usermodel/XSLFPictureShape;

    invoke-virtual {v3}, Lorg/apache/poi/xslf/usermodel/XSLFPictureShape;->getPictureData()Lorg/apache/poi/xslf/usermodel/XSLFPictureData;
    ...
    invoke-virtual {v4}, Lorg/apache/poi/xslf/usermodel/XSLFSheet;->getSlideShow()Lorg/apache/poi/xslf/usermodel/XMLSlideShow;

    move-result-object v4

    invoke-virtual {v3}, Lorg/apache/poi/xslf/usermodel/XSLFPictureData;->getData()[B

    move-result-object v5

    invoke-virtual {v3}, Lorg/apache/poi/xslf/usermodel/XSLFPictureData;->getType()Lorg/apache/poi/sl/usermodel/PictureData$PictureType;

    move-result-object v3

    invoke-virtual {v4, v5, v3}, Lorg/apache/poi/xslf/usermodel/XMLSlideShow;->addPicture([BLorg/apache/poi/sl/usermodel/PictureData$PictureType;)Lorg/apache/poi/xslf/usermodel/XSLFPictureData;

    move-result-object v3

    invoke-virtual {p0, v3}, Lorg/apache/poi/xslf/usermodel/XSLFGroupShape;->createPicture(Lorg/apache/poi/sl/usermodel/PictureData;)Lorg/apache/poi/xslf/usermodel/XSLFPictureShape;
    ...
    :cond_5
    instance-of v3, v2, Lorg/apache/poi/xslf/usermodel/XSLFGroupShape;
    ...
    :cond_6
    instance-of v3, v2, Lorg/apache/poi/xslf/usermodel/XSLFTable;
    ...
    :cond_7
    sget-object v3, Lorg/apache/poi/xslf/usermodel/XSLFGroupShape;->_logger:Lorg/apache/poi/util/POILogger;

    new-instance v4, Ljava/lang/StringBuilder;

    const-string v5, "copying of class "
