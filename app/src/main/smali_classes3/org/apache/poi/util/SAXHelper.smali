...
.method static constructor <clinit>()V
    ...
    const-string v3, "Failed to create SAXParserFactory"

    const-class v4, Lorg/apache/poi/util/SAXHelper;

    invoke-static {v4}, Lorg/apache/poi/util/POILogFactory;->getLogger(Ljava/lang/Class;)Lorg/apache/poi/util/POILogger;

    move-result-object v4

    sput-object v4, Lorg/apache/poi/util/SAXHelper;->logger:Lorg/apache/poi/util/POILogger;

    new-instance v4, Lorg/apache/poi/util/SAXHelper$1;

    invoke-direct {v4}, Lorg/apache/poi/util/SAXHelper$1;-><init>()V

    sput-object v4, Lorg/apache/poi/util/SAXHelper;->IGNORING_ENTITY_RESOLVER:Lorg/xml/sax/EntityResolver;
    ...
    invoke-virtual {v5, v2}, Ljavax/xml/parsers/SAXParserFactory;->setValidating(Z)V

    invoke-virtual {v5, v1}, Ljavax/xml/parsers/SAXParserFactory;->setNamespaceAware(Z)V
    :try_end_0
    ...
    invoke-virtual {v6, v4, v0}, Lorg/apache/poi/util/POILogger;->log(I[Ljava/lang/Object;)V
...
.method private static trySetSAXFeature(Lorg/xml/sax/XMLReader;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-interface {p0, p1, v3}, Lorg/xml/sax/XMLReader;->setFeature(Ljava/lang/String;Z)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_1
    ...
    invoke-virtual {v5, v4, v2}, Lorg/apache/poi/util/POILogger;->log(I[Ljava/lang/Object;)V
...
.method private static trySetXercesSecurityManager(Lorg/xml/sax/XMLReader;)V
    ...
    const-string v2, "com.sun.org.apache.xerces.internal.util.SecurityManager"
    ...
    invoke-interface {p0, v6, v5}, Lorg/xml/sax/XMLReader;->setProperty(Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    sput-wide v5, Lorg/apache/poi/util/SAXHelper;->lastLog:J
