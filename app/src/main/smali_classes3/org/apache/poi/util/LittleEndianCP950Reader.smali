...
.method private handleF9(I)I
    ...
    const-string v2, "couldn\'t create char for: f9 "
...
.method private handleRange1(II)I
    ...
    invoke-static {p1, v0, v1, v2}, Lch/qos/logback/core/joran/util/a;->b(IIII)I
...
.method public read()I
    ...
    iget v1, p0, Lorg/apache/poi/util/LittleEndianCP950Reader;->offset:I

    const/4 v2, 0x1

    add-int/lit8 v3, v1, 0x1

    iget-object v4, p0, Lorg/apache/poi/util/LittleEndianCP950Reader;->data:[B

    array-length v5, v4

    if-gt v3, v5, :cond_8

    iget v3, p0, Lorg/apache/poi/util/LittleEndianCP950Reader;->startOffset:I

    sub-int v3, v1, v3

    iget v5, p0, Lorg/apache/poi/util/LittleEndianCP950Reader;->length:I
    ...
    iput v5, p0, Lorg/apache/poi/util/LittleEndianCP950Reader;->trailing:I
    ...
    iput v1, p0, Lorg/apache/poi/util/LittleEndianCP950Reader;->leading:I

    iget-object v1, p0, Lorg/apache/poi/util/LittleEndianCP950Reader;->decoder:Ljava/nio/charset/CharsetDecoder;
    ...
    iget v4, p0, Lorg/apache/poi/util/LittleEndianCP950Reader;->trailing:I
    ...
    invoke-direct {p0, v1, v4}, Lorg/apache/poi/util/LittleEndianCP950Reader;->handleRange1(II)I
    ...
    invoke-direct {p0, v1, v4}, Lorg/apache/poi/util/LittleEndianCP950Reader;->handleRange2(II)I
    ...
    invoke-direct {p0, v1, v4}, Lorg/apache/poi/util/LittleEndianCP950Reader;->handleRange3(II)I
    ...
    invoke-direct {p0, v1, v4}, Lorg/apache/poi/util/LittleEndianCP950Reader;->handleRange4(II)I
    ...
    :cond_6
    iget-object v1, p0, Lorg/apache/poi/util/LittleEndianCP950Reader;->charBuffer:Ljava/nio/CharBuffer;
    ...
    iget v3, p0, Lorg/apache/poi/util/LittleEndianCP950Reader;->leading:I
    ...
    iget v3, p0, Lorg/apache/poi/util/LittleEndianCP950Reader;->trailing:I
    ...
    iget-object v3, p0, Lorg/apache/poi/util/LittleEndianCP950Reader;->doubleByteBuffer:Ljava/nio/ByteBuffer;

    iget-object v4, p0, Lorg/apache/poi/util/LittleEndianCP950Reader;->charBuffer:Ljava/nio/CharBuffer;

    invoke-virtual {v1, v3, v4, v2}, Ljava/nio/charset/CharsetDecoder;->decode(Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;Z)Ljava/nio/charset/CoderResult;
    ...
    sget-object v1, Lorg/apache/poi/util/LittleEndianCP950Reader;->LOGGER:Lorg/apache/poi/util/POILogger;

    new-instance v3, Ljava/lang/StringBuilder;

    const-string v4, "couldn\'t create char for: "

    invoke-direct {v3, v4}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget v4, p0, Lorg/apache/poi/util/LittleEndianCP950Reader;->leading:I
