...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/dropbox/core/v2/teamlog/FedHandshakeAction;->INVITED:Lcom/dropbox/core/v2/teamlog/FedHandshakeAction;
    ...
    sput-object v1, Lcom/dropbox/core/v2/teamlog/FedHandshakeAction;->ACCEPTED_INVITE:Lcom/dropbox/core/v2/teamlog/FedHandshakeAction;

    new-instance v3, Lcom/dropbox/core/v2/teamlog/FedHandshakeAction;

    const-string v5, "REJECTED_INVITE"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/dropbox/core/v2/teamlog/FedHandshakeAction;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/dropbox/core/v2/teamlog/FedHandshakeAction;->REJECTED_INVITE:Lcom/dropbox/core/v2/teamlog/FedHandshakeAction;

    new-instance v5, Lcom/dropbox/core/v2/teamlog/FedHandshakeAction;

    const-string v7, "CANCELED_INVITE"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/dropbox/core/v2/teamlog/FedHandshakeAction;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/dropbox/core/v2/teamlog/FedHandshakeAction;->CANCELED_INVITE:Lcom/dropbox/core/v2/teamlog/FedHandshakeAction;

    new-instance v7, Lcom/dropbox/core/v2/teamlog/FedHandshakeAction;

    const-string v9, "REMOVED_TEAM"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/dropbox/core/v2/teamlog/FedHandshakeAction;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/dropbox/core/v2/teamlog/FedHandshakeAction;->REMOVED_TEAM:Lcom/dropbox/core/v2/teamlog/FedHandshakeAction;

    new-instance v9, Lcom/dropbox/core/v2/teamlog/FedHandshakeAction;

    const-string v11, "INVITE_EXPIRED"

    const/4 v12, 0x5

    invoke-direct {v9, v11, v12}, Lcom/dropbox/core/v2/teamlog/FedHandshakeAction;-><init>(Ljava/lang/String;I)V

    sput-object v9, Lcom/dropbox/core/v2/teamlog/FedHandshakeAction;->INVITE_EXPIRED:Lcom/dropbox/core/v2/teamlog/FedHandshakeAction;
