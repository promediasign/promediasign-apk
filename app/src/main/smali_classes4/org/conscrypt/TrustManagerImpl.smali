...
.method private checkTrusted([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljavax/net/ssl/SSLSession;Ljavax/net/ssl/SSLParameters;Z)Ljava/util/List;
    ...
    invoke-static {p4}, Lio/netty/handler/ssl/a;->e(Ljavax/net/ssl/SSLParameters;)Ljava/lang/String;
...
.method private static getHandshakeSessionOrThrow(Ljavax/net/ssl/SSLSocket;)Ljavax/net/ssl/SSLSession;
    ...
    invoke-static {p0}, Lio/netty/handler/ssl/a;->n(Ljavax/net/ssl/SSLSocket;)Ljavax/net/ssl/SSLSession;
...
.method private setOcspResponses(Ljava/security/cert/PKIXParameters;Ljava/security/cert/X509Certificate;[B)V
    ...
    invoke-static {v2}, Lio/netty/handler/ssl/a;->y(Ljava/security/cert/PKIXCertPathChecker;)Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-static {v2}, Lio/netty/handler/ssl/a;->j(Ljava/security/cert/PKIXCertPathChecker;)Ljava/security/cert/PKIXRevocationChecker;
    ...
    invoke-static {v1}, Lio/netty/handler/ssl/a;->g(Ljava/security/cert/CertPathValidator;)Ljava/security/cert/CertPathChecker;

    move-result-object v1

    invoke-static {v1}, Lio/netty/handler/ssl/a;->i(Ljava/lang/Object;)Ljava/security/cert/PKIXRevocationChecker;
    ...
    invoke-static {}, Lio/netty/handler/ssl/a;->h()Ljava/security/cert/PKIXRevocationChecker$Option;
    ...
    invoke-static {v1, v2}, Lio/netty/handler/ssl/a;->s(Ljava/security/cert/PKIXRevocationChecker;Ljava/util/Set;)V
    ...
    invoke-static {v1, p2}, Lio/netty/handler/ssl/a;->r(Ljava/security/cert/PKIXRevocationChecker;Ljava/util/Map;)V
...
.method public checkClientTrusted([Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljavax/net/ssl/SSLEngine;)V
    ...
    .line 4
    invoke-static {p3}, Lio/netty/channel/socket/nio/a;->o(Ljavax/net/ssl/SSLEngine;)Ljavax/net/ssl/SSLSession;
