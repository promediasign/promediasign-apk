...
# static fields
.field private static final CVS_ID:Ljava/lang/String; = "@(#) $RCSfile: OracleV1DOMAdapter.java,v $ $Revision: 1.20 $ $Date: 2007/11/10 05:28:59 $ $Name:  $"
...
.method public createDocument()Lorg/w3c/dom/Document;
    ...
    :try_start_0
    const-string v0, "oracle.xml.parser.XMLDocument"
...
.method public getDocument(Ljava/io/InputStream;Z)Lorg/w3c/dom/Document;
    ...
    :try_start_0
    const-string v1, "oracle.xml.parser.XMLParser"
    ...
    sget-object v4, Lorg/jdom/adapters/OracleV1DOMAdapter;->class$org$xml$sax$InputSource:Ljava/lang/Class;

    if-nez v4, :cond_0

    const-string v4, "org.xml.sax.InputSource"

    invoke-static {v4}, Lorg/jdom/adapters/OracleV1DOMAdapter;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v4

    sput-object v4, Lorg/jdom/adapters/OracleV1DOMAdapter;->class$org$xml$sax$InputSource:Ljava/lang/Class;
