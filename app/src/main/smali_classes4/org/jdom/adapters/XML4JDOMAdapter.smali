...
# static fields
.field private static final CVS_ID:Ljava/lang/String; = "@(#) $RCSfile: XML4JDOMAdapter.java,v $ $Revision: 1.18 $ $Date: 2007/11/10 05:28:59 $ $Name:  $"
...
.method public getDocument(Ljava/io/InputStream;Z)Lorg/w3c/dom/Document;
    ...
    sget-object v6, Lorg/jdom/adapters/XML4JDOMAdapter;->class$java$lang$String:Ljava/lang/Class;

    if-nez v6, :cond_0

    const-string v6, "java.lang.String"

    invoke-static {v6}, Lorg/jdom/adapters/XML4JDOMAdapter;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v6

    sput-object v6, Lorg/jdom/adapters/XML4JDOMAdapter;->class$java$lang$String:Ljava/lang/Class;
    ...
    sget-object v0, Lorg/jdom/adapters/XML4JDOMAdapter;->class$org$xml$sax$ErrorHandler:Ljava/lang/Class;

    if-nez v0, :cond_1

    const-string v0, "org.xml.sax.ErrorHandler"

    invoke-static {v0}, Lorg/jdom/adapters/XML4JDOMAdapter;->class$(Ljava/lang/String;)Ljava/lang/Class;

    move-result-object v0

    sput-object v0, Lorg/jdom/adapters/XML4JDOMAdapter;->class$org$xml$sax$ErrorHandler:Ljava/lang/Class;
    ...
    sget-object v0, Lorg/jdom/adapters/XML4JDOMAdapter;->class$org$xml$sax$InputSource:Ljava/lang/Class;
    ...
    sput-object v0, Lorg/jdom/adapters/XML4JDOMAdapter;->class$org$xml$sax$InputSource:Ljava/lang/Class;
