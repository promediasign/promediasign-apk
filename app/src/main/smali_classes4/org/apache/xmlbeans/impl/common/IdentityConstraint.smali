...
.method private emitError(Lorg/apache/xmlbeans/impl/common/ValidatorListener$Event;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lorg/apache/xmlbeans/impl/common/IdentityConstraint;->_errorListener:Ljava/util/Collection;

    if-eqz v0, :cond_2

    sget-boolean v1, Lorg/apache/xmlbeans/impl/common/IdentityConstraint;->$assertionsDisabled:Z
    ...
    invoke-static {p2, v1, p1}, Lorg/apache/xmlbeans/impl/common/IdentityConstraint;->errorForEvent(Ljava/lang/String;ILorg/apache/xmlbeans/impl/common/ValidatorListener$Event;)Lorg/apache/xmlbeans/XmlError;
...
.method private emitError(Lorg/apache/xmlbeans/impl/common/ValidatorListener$Event;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {p2, p3, v1, p1}, Lorg/apache/xmlbeans/impl/common/IdentityConstraint;->errorForEvent(Ljava/lang/String;[Ljava/lang/Object;ILorg/apache/xmlbeans/impl/common/ValidatorListener$Event;)Lorg/apache/xmlbeans/XmlError;
...
.method public static errorForEvent(Ljava/lang/String;ILorg/apache/xmlbeans/impl/common/ValidatorListener$Event;)Lorg/apache/xmlbeans/XmlError;
    ...
    :cond_0
    invoke-interface {p2}, Lorg/apache/xmlbeans/impl/common/ValidatorListener$Event;->getLocation()Lorg/apache/poi/javax/xml/stream/Location;

    move-result-object p2

    if-eqz p2, :cond_1

    invoke-interface {p2}, Lorg/apache/poi/javax/xml/stream/Location;->getSystemId()Ljava/lang/String;
    ...
    invoke-interface {p2}, Lorg/apache/poi/javax/xml/stream/Location;->getCharacterOffset()I
...
.method public static errorForEvent(Ljava/lang/String;[Ljava/lang/Object;ILorg/apache/xmlbeans/impl/common/ValidatorListener$Event;)Lorg/apache/xmlbeans/XmlError;
    ...
    :cond_0
    invoke-interface {p3}, Lorg/apache/xmlbeans/impl/common/ValidatorListener$Event;->getLocation()Lorg/apache/poi/javax/xml/stream/Location;

    move-result-object p3

    if-eqz p3, :cond_1

    invoke-interface {p3}, Lorg/apache/poi/javax/xml/stream/Location;->getSystemId()Ljava/lang/String;

    move-result-object v3

    invoke-interface {p3}, Lorg/apache/poi/javax/xml/stream/Location;->getLineNumber()I

    move-result v4

    invoke-interface {p3}, Lorg/apache/poi/javax/xml/stream/Location;->getColumnNumber()I

    move-result v5

    invoke-interface {p3}, Lorg/apache/poi/javax/xml/stream/Location;->getCharacterOffset()I
...
.method private setSavePoint(Lorg/apache/xmlbeans/impl/common/IdentityConstraint$ConstraintState;)V
    ...
    iget-boolean v1, v0, Lorg/apache/xmlbeans/impl/common/IdentityConstraint$ElementState;->_hasConstraints:Z

    if-nez v1, :cond_0

    iput-object p1, v0, Lorg/apache/xmlbeans/impl/common/IdentityConstraint$ElementState;->_savePoint:Lorg/apache/xmlbeans/impl/common/IdentityConstraint$ConstraintState;

    :cond_0
    const/4 p1, 0x1

    iput-boolean p1, v0, Lorg/apache/xmlbeans/impl/common/IdentityConstraint$ElementState;->_hasConstraints:Z
...
.method public attr(Lorg/apache/xmlbeans/impl/common/ValidatorListener$Event;Lorg/apache/poi/javax/xml/namespace/QName;Lorg/apache/xmlbeans/SchemaType;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Lorg/apache/xmlbeans/impl/common/IdentityConstraint$ConstraintState;->attr(Lorg/apache/xmlbeans/impl/common/ValidatorListener$Event;Lorg/apache/poi/javax/xml/namespace/QName;Lorg/apache/xmlbeans/SchemaType;Ljava/lang/String;)V
...
.method public endElement(Lorg/apache/xmlbeans/impl/common/ValidatorListener$Event;)V
    ...
    invoke-virtual {v0, p1}, Lorg/apache/xmlbeans/impl/common/IdentityConstraint$ConstraintState;->endElement(Lorg/apache/xmlbeans/impl/common/ValidatorListener$Event;)V
...
.method public isValid()Z
    ...
    iget-boolean v0, p0, Lorg/apache/xmlbeans/impl/common/IdentityConstraint;->_invalid:Z
...
.method public text(Lorg/apache/xmlbeans/impl/common/ValidatorListener$Event;Lorg/apache/xmlbeans/SchemaType;Ljava/lang/String;Z)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Lorg/apache/xmlbeans/impl/common/IdentityConstraint$ConstraintState;->text(Lorg/apache/xmlbeans/impl/common/ValidatorListener$Event;Lorg/apache/xmlbeans/SchemaType;Ljava/lang/String;Z)V
