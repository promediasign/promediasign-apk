...
.field private _qnameAttMap:Ljava/util/Map;

.field private _qnameDocTypeMap:Ljava/util/Map;

.field private _qnameElemMap:Ljava/util/Map;

.field private _qnameTypeMap:Ljava/util/Map;

.field private _suffixMap:Ljava/util/Map;

.field private _suffixMapByUriPrefix:Ljava/util/Map;

.field private _userTypes:Ljava/util/Map;
...
.method private constructor <init>([Lorg/apache/xmlbeans/impl/xb/xmlconfig/ConfigDocument$Config;[Ljava/io/File;[Ljava/io/File;)V
    ...
    iput-object v0, p0, Lorg/apache/xmlbeans/impl/config/BindingConfigImpl;->_qnameTypeMap:Ljava/util/Map;

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, Lorg/apache/xmlbeans/impl/config/BindingConfigImpl;->_qnameDocTypeMap:Ljava/util/Map;

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, Lorg/apache/xmlbeans/impl/config/BindingConfigImpl;->_qnameElemMap:Ljava/util/Map;

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, Lorg/apache/xmlbeans/impl/config/BindingConfigImpl;->_qnameAttMap:Ljava/util/Map;
    ...
    iput-object v0, p0, Lorg/apache/xmlbeans/impl/config/BindingConfigImpl;->_userTypes:Ljava/util/Map;
    ...
    invoke-interface {v5}, Lorg/apache/xmlbeans/impl/xb/xmlconfig/Qnameconfig;->xgetTarget()Lorg/apache/xmlbeans/impl/xb/xmlconfig/Qnametargetlist;

    move-result-object v5

    invoke-interface {v5}, Lorg/apache/xmlbeans/impl/xb/xmlconfig/Qnametargetlist;->xgetListValue()Ljava/util/List;

    move-result-object v5

    aget-object v6, v3, v4

    invoke-interface {v6}, Lorg/apache/xmlbeans/impl/xb/xmlconfig/Qnameconfig;->getName()Lorg/apache/poi/javax/xml/namespace/QName;
    ...
    check-cast v9, Lorg/apache/xmlbeans/impl/xb/xmlconfig/Qnametargetenum;

    invoke-interface {v9}, Lorg/apache/xmlbeans/impl/xb/xmlconfig/Qnametargetenum;->enumValue()Lorg/apache/xmlbeans/StringEnumAbstractBase;

    move-result-object v9

    invoke-virtual {v9}, Lorg/apache/xmlbeans/StringEnumAbstractBase;->intValue()I
    ...
    :cond_1
    iget-object v9, p0, Lorg/apache/xmlbeans/impl/config/BindingConfigImpl;->_qnameAttMap:Ljava/util/Map;
    ...
    :cond_2
    iget-object v9, p0, Lorg/apache/xmlbeans/impl/config/BindingConfigImpl;->_qnameElemMap:Ljava/util/Map;

    goto :goto_4

    :cond_3
    iget-object v9, p0, Lorg/apache/xmlbeans/impl/config/BindingConfigImpl;->_qnameDocTypeMap:Ljava/util/Map;

    goto :goto_4

    :cond_4
    iget-object v9, p0, Lorg/apache/xmlbeans/impl/config/BindingConfigImpl;->_qnameTypeMap:Ljava/util/Map;
    ...
    invoke-direct {p0, p2, p3, v5}, Lorg/apache/xmlbeans/impl/config/BindingConfigImpl;->recordExtensionSetting([Ljava/io/File;[Ljava/io/File;Lorg/apache/xmlbeans/impl/xb/xmlconfig/Extensionconfig;)V
    ...
    :cond_7
    invoke-interface {v2}, Lorg/apache/xmlbeans/impl/xb/xmlconfig/ConfigDocument$Config;->getUsertypeArray()[Lorg/apache/xmlbeans/impl/xb/xmlconfig/Usertypeconfig;
    ...
    invoke-direct {p0, p2, p3, v4}, Lorg/apache/xmlbeans/impl/config/BindingConfigImpl;->recordUserTypeSetting([Ljava/io/File;[Ljava/io/File;Lorg/apache/xmlbeans/impl/xb/xmlconfig/Usertypeconfig;)V
...
.method private getJamLoader([Ljava/io/File;[Ljava/io/File;)Lorg/apache/xmlbeans/impl/jam/JamClassLoader;
    ...
    invoke-interface {v1, p1}, Lorg/apache/xmlbeans/impl/jam/JamServiceParams;->addClassLoader(Ljava/lang/ClassLoader;)V
    ...
    invoke-interface {v1, p1}, Lorg/apache/xmlbeans/impl/jam/JamServiceParams;->addClasspath(Ljava/io/File;)V
    ...
    invoke-interface {p1}, Lorg/apache/xmlbeans/impl/jam/JamService;->getClassLoader()Lorg/apache/xmlbeans/impl/jam/JamClassLoader;
    ...
    :catch_0
    const-string p1, "Error when accessing .java files."
...
.method private recordUserTypeSetting([Ljava/io/File;[Ljava/io/File;Lorg/apache/xmlbeans/impl/xb/xmlconfig/Usertypeconfig;)V
    .locals 0
    ...
    invoke-static {p1, p3}, Lorg/apache/xmlbeans/impl/config/UserTypeImpl;->newInstance(Lorg/apache/xmlbeans/impl/jam/JamClassLoader;Lorg/apache/xmlbeans/impl/xb/xmlconfig/Usertypeconfig;)Lorg/apache/xmlbeans/impl/config/UserTypeImpl;

    move-result-object p1

    iget-object p2, p0, Lorg/apache/xmlbeans/impl/config/BindingConfigImpl;->_userTypes:Ljava/util/Map;

    invoke-virtual {p1}, Lorg/apache/xmlbeans/impl/config/UserTypeImpl;->getName()Lorg/apache/poi/javax/xml/namespace/QName;
...
.method public addInterfaceExtension(Lorg/apache/xmlbeans/impl/config/InterfaceExtensionImpl;)V
    ...
    :cond_0
    iget-object v0, p0, Lorg/apache/xmlbeans/impl/config/BindingConfigImpl;->_interfaceExtensions:Ljava/util/List;
...
.method public getInterfaceExtensions()[Lorg/apache/xmlbeans/InterfaceExtension;
    ...
    new-array v1, v1, [Lorg/apache/xmlbeans/InterfaceExtension;

    invoke-interface {v0, v1}, Ljava/util/List;->toArray([Ljava/lang/Object;)[Ljava/lang/Object;

    move-result-object v0

    check-cast v0, [Lorg/apache/xmlbeans/InterfaceExtension;
...
.method public getInterfaceExtensions(Ljava/lang/String;)[Lorg/apache/xmlbeans/InterfaceExtension;
    ...
    new-array p1, p1, [Lorg/apache/xmlbeans/InterfaceExtension;

    invoke-virtual {v0, p1}, Ljava/util/ArrayList;->toArray([Ljava/lang/Object;)[Ljava/lang/Object;

    move-result-object p1

    check-cast p1, [Lorg/apache/xmlbeans/InterfaceExtension;
...
.method public getPrePostExtensions()[Lorg/apache/xmlbeans/PrePostExtension;
    ...
    new-array v1, v1, [Lorg/apache/xmlbeans/PrePostExtension;

    invoke-interface {v0, v1}, Ljava/util/List;->toArray([Ljava/lang/Object;)[Ljava/lang/Object;

    move-result-object v0

    check-cast v0, [Lorg/apache/xmlbeans/PrePostExtension;
...
.method public lookupJavanameForQName(Lorg/apache/poi/javax/xml/namespace/QName;)Ljava/lang/String;
    ...
    .line 1
    iget-object v0, p0, Lorg/apache/xmlbeans/impl/config/BindingConfigImpl;->_qnameTypeMap:Ljava/util/Map;
    ...
    :cond_0
    iget-object v0, p0, Lorg/apache/xmlbeans/impl/config/BindingConfigImpl;->_qnameDocTypeMap:Ljava/util/Map;
...
.method public lookupJavanameForQName(Lorg/apache/poi/javax/xml/namespace/QName;I)Ljava/lang/String;
    ...
    :cond_0
    iget-object p2, p0, Lorg/apache/xmlbeans/impl/config/BindingConfigImpl;->_qnameAttMap:Ljava/util/Map;
    ...
    :cond_1
    iget-object p2, p0, Lorg/apache/xmlbeans/impl/config/BindingConfigImpl;->_qnameElemMap:Ljava/util/Map;

    goto :goto_0

    :cond_2
    iget-object p2, p0, Lorg/apache/xmlbeans/impl/config/BindingConfigImpl;->_qnameDocTypeMap:Ljava/util/Map;

    goto :goto_0

    :cond_3
    iget-object p2, p0, Lorg/apache/xmlbeans/impl/config/BindingConfigImpl;->_qnameTypeMap:Ljava/util/Map;
...
.method public lookupUserTypeForQName(Lorg/apache/poi/javax/xml/namespace/QName;)Lorg/apache/xmlbeans/UserType;
    ...
    :cond_0
    iget-object v0, p0, Lorg/apache/xmlbeans/impl/config/BindingConfigImpl;->_userTypes:Ljava/util/Map;

    invoke-interface {v0, p1}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lorg/apache/xmlbeans/UserType;
...
.method public secondPhaseValidation()V
    ...
    check-cast v0, Lorg/apache/xmlbeans/impl/config/InterfaceExtensionImpl$MethodSignatureImpl;
    ...
    invoke-virtual {v0}, Lorg/apache/xmlbeans/impl/config/InterfaceExtensionImpl$MethodSignatureImpl;->getReturnType()Ljava/lang/String;
    ...
    const-string v2, "Colliding methods \'"
    ...
    invoke-virtual {v0}, Lorg/apache/xmlbeans/impl/config/InterfaceExtensionImpl$MethodSignatureImpl;->getInterfaceName()Ljava/lang/String;
    ...
    invoke-static {v0, v4}, Lorg/apache/xmlbeans/impl/config/BindingConfigImpl;->error(Ljava/lang/String;Lorg/apache/xmlbeans/XmlObject;)V
