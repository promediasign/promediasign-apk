...
.method private setPosition(Lorg/apache/xmlbeans/impl/jam/mutable/MAnnotation;Lcom/sun/javadoc/Tag;)V
    ...
    invoke-interface {p2}, Lcom/sun/javadoc/SourcePosition;->line()I

    move-result v0

    invoke-interface {p1, v0}, Lorg/apache/xmlbeans/impl/jam/mutable/MSourcePosition;->setLine(I)V

    invoke-interface {p2}, Lcom/sun/javadoc/SourcePosition;->column()I

    move-result v0

    invoke-interface {p1, v0}, Lorg/apache/xmlbeans/impl/jam/mutable/MSourcePosition;->setColumn(I)V

    invoke-interface {p2}, Lcom/sun/javadoc/SourcePosition;->file()Ljava/io/File;
    ...
    invoke-interface {p1, p2}, Lorg/apache/xmlbeans/impl/jam/mutable/MSourcePosition;->setSourceURI(Ljava/net/URI;)V
...
.method public init(Lorg/apache/xmlbeans/impl/jam/provider/JamServiceContext;)V
    ...
    const-string v0, "JavadocTagParser.init() called twice"
