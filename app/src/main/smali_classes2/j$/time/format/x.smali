...
.method constructor <init>(Lj$/time/format/DateTimeFormatter;)V
    ...
    new-instance p1, Lj$/time/format/F;

    invoke-direct {p1}, Lj$/time/format/F;-><init>()V
...
.method private e()Lj$/time/format/F;
    .locals 2
...
.method final g()Lj$/time/format/E;
    ...
    invoke-virtual {v0}, Lj$/time/format/DateTimeFormatter;->b()Lj$/time/format/E;
...
.method final h()Lj$/time/chrono/l;
    .locals 1

    invoke-direct {p0}, Lj$/time/format/x;->e()Lj$/time/format/F;

    move-result-object v0

    iget-object v0, v0, Lj$/time/format/F;->c:Lj$/time/chrono/l;
...
.method final j(Lj$/time/temporal/a;)Ljava/lang/Long;
    ...
    iget-object v0, v0, Lj$/time/format/F;->a:Ljava/util/HashMap;
...
.method final n(Lj$/time/ZoneId;)V
    ...
    iput-object p1, v0, Lj$/time/format/F;->b:Lj$/time/ZoneId;

    return-void
.end method

.method final o(Lj$/time/temporal/p;JII)I
    .locals 2
...
.method final p()V
    ...
    iput-boolean v1, v0, Lj$/time/format/F;->d:Z
...
.method final r()V
    ...
    invoke-direct {v2}, Lj$/time/format/F;-><init>()V

    iget-object v3, v2, Lj$/time/format/F;->a:Ljava/util/HashMap;

    iget-object v4, v1, Lj$/time/format/F;->a:Ljava/util/HashMap;

    invoke-virtual {v3, v4}, Ljava/util/HashMap;->putAll(Ljava/util/Map;)V

    iget-object v3, v1, Lj$/time/format/F;->b:Lj$/time/ZoneId;

    iput-object v3, v2, Lj$/time/format/F;->b:Lj$/time/ZoneId;

    iget-object v3, v1, Lj$/time/format/F;->c:Lj$/time/chrono/l;

    iput-object v3, v2, Lj$/time/format/F;->c:Lj$/time/chrono/l;

    iget-boolean v1, v1, Lj$/time/format/F;->d:Z

    iput-boolean v1, v2, Lj$/time/format/F;->d:Z
...
.method final t(Lj$/time/format/G;Ljava/util/Set;)Lj$/time/temporal/TemporalAccessor;
    .locals 2
    ...
    invoke-virtual {p0}, Lj$/time/format/x;->h()Lj$/time/chrono/l;

    move-result-object v1

    iput-object v1, v0, Lj$/time/format/F;->c:Lj$/time/chrono/l;

    iget-object v1, v0, Lj$/time/format/F;->b:Lj$/time/ZoneId;
    ...
    :goto_0
    iput-object v1, v0, Lj$/time/format/F;->b:Lj$/time/ZoneId;

    invoke-virtual {v0, p1, p2}, Lj$/time/format/F;->h(Lj$/time/format/G;Ljava/util/Set;)V
