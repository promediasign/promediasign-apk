...
.method constructor <init>(Lj$/time/temporal/p;IILj$/time/format/H;)V
    .locals 0
    ...
    iput-object p4, p0, Lj$/time/format/k;->d:Lj$/time/format/H;
...
.method protected constructor <init>(Lj$/time/temporal/p;IILj$/time/format/H;I)V
    .locals 0
...
.method static bridge synthetic a(Lj$/time/format/k;)Lj$/time/format/H;
    .locals 0

    iget-object p0, p0, Lj$/time/format/k;->d:Lj$/time/format/H;
...
.method c(Lj$/time/format/x;)Z
    ...
    iget-object p1, p0, Lj$/time/format/k;->d:Lj$/time/format/H;
...
.method e()Lj$/time/format/k;
    ...
    iget-object v6, p0, Lj$/time/format/k;->d:Lj$/time/format/H;
    ...
    invoke-direct/range {v2 .. v7}, Lj$/time/format/k;-><init>(Lj$/time/temporal/p;IILj$/time/format/H;I)V
...
.method f(I)Lj$/time/format/k;
    ...
    iget-object v4, p0, Lj$/time/format/k;->d:Lj$/time/format/H;
...
.method public n(Lj$/time/format/A;Ljava/lang/StringBuilder;)Z
    .locals 13
    ...
    invoke-virtual {p0, p1, v3, v4}, Lj$/time/format/k;->b(Lj$/time/format/A;J)J

    move-result-wide v3

    invoke-virtual {p1}, Lj$/time/format/A;->b()Lj$/time/format/E;
    ...
    iget-object v11, p0, Lj$/time/format/k;->d:Lj$/time/format/H;
...
.method public p(Lj$/time/format/x;Ljava/lang/CharSequence;I)I
    .locals 20
    ...
    invoke-virtual/range {p1 .. p1}, Lj$/time/format/x;->g()Lj$/time/format/E;
    ...
    iget-object v7, v6, Lj$/time/format/k;->d:Lj$/time/format/H;
    ...
    :goto_0
    invoke-virtual {v7, v3, v2, v4}, Lj$/time/format/H;->n(ZZZ)Z
    ...
    :goto_1
    invoke-virtual {v7, v9, v2, v4}, Lj$/time/format/H;->n(ZZZ)Z
    ...
    :cond_6
    sget-object v2, Lj$/time/format/H;->ALWAYS:Lj$/time/format/H;
    ...
    invoke-virtual {v3, v15}, Lj$/time/format/E;->a(C)I
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v5, p0, Lj$/time/format/k;->d:Lj$/time/format/H;
    ...
    sget-object v7, Lj$/time/format/H;->NOT_NEGATIVE:Lj$/time/format/H;
