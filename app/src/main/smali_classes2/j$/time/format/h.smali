...
.method public final n(Lj$/time/format/A;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {v2, v1}, Lj$/time/format/A;->e(Lj$/time/temporal/p;)Ljava/lang/Long;
    ...
    invoke-interface {v3, v4}, Lj$/time/temporal/TemporalAccessor;->f(Lj$/time/temporal/p;)Z
    ...
    invoke-interface {v2, v4}, Lj$/time/temporal/TemporalAccessor;->v(Lj$/time/temporal/p;)J
    ...
    invoke-static {v5, v6, v3, v7}, Lj$/time/LocalDateTime;->g0(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual {v5}, Lj$/time/LocalDateTime;->Z()I
    ...
    invoke-static {v7, v8, v3, v13}, Lj$/time/LocalDateTime;->g0(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual {v7}, Lj$/time/LocalDateTime;->Z()I
    ...
    invoke-virtual {v7}, Lj$/time/LocalDateTime;->a0()I
...
.method public final p(Lj$/time/format/x;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v0, v4, v2}, Lj$/time/format/w;->p(Lj$/time/temporal/p;I)V

    invoke-virtual {v0, v3}, Lj$/time/format/w;->e(C)V

    sget-object v3, Lj$/time/temporal/a;->SECOND_OF_MINUTE:Lj$/time/temporal/a;

    invoke-virtual {v0, v3, v2}, Lj$/time/format/w;->p(Lj$/time/temporal/p;I)V
    ...
    invoke-virtual {v0, v5}, Lj$/time/format/w;->z(Ljava/util/Locale;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v0, v5, v9, v6}, Lj$/time/format/e;->p(Lj$/time/format/x;Ljava/lang/CharSequence;I)I
    ...
    :try_start_0
    invoke-static/range {v12 .. v17}, Lj$/time/LocalDateTime;->e0(IIIIII)Lj$/time/LocalDateTime;

    move-result-object v0

    int-to-long v1, v2

    invoke-virtual {v0, v1, v2}, Lj$/time/LocalDateTime;->i0(J)Lj$/time/LocalDateTime;
    ...
    invoke-static {v10, v11, v2, v3}, Lj$/com/android/tools/r8/a;->l(JJ)J
