...
.method public constructor <init>(Lj$/util/stream/A1;Lj$/util/stream/K0;I)V
    ...
    .line 0
    invoke-direct {p0, p1, p2, p3, v0}, Lj$/util/stream/A1;-><init>(Lj$/util/stream/A1;Lj$/util/stream/L0;IB)V
...
.method public constructor <init>(Lj$/util/stream/A1;Lj$/util/stream/L0;I)V
    .locals 1
...
.method constructor <init>(Lj$/util/stream/A1;Lj$/util/stream/L0;IB)V
    .locals 0

    .line 0
    invoke-direct {p0, p1}, Ljava/util/concurrent/CountedCompleter;-><init>(Ljava/util/concurrent/CountedCompleter;)V

    iput-object p2, p0, Lj$/util/stream/A1;->a:Lj$/util/stream/L0;
...
.method public constructor <init>(Lj$/util/stream/L0;Ljava/lang/Object;I)V
    ...
    iput-object p1, p0, Lj$/util/stream/A1;->a:Lj$/util/stream/L0;
...
.method final a()V
    ...
    .line 0
    iget-object v0, p0, Lj$/util/stream/A1;->a:Lj$/util/stream/L0;
...
.method final b(II)Lj$/util/stream/A1;
    ...
    iget-object v1, p0, Lj$/util/stream/A1;->a:Lj$/util/stream/L0;

    invoke-interface {v1, p1}, Lj$/util/stream/L0;->b(I)Lj$/util/stream/L0;

    move-result-object p1

    invoke-direct {v0, p0, p1, p2}, Lj$/util/stream/A1;-><init>(Lj$/util/stream/A1;Lj$/util/stream/L0;I)V
...
.method public final compute()V
    ...
    .line 0
    :goto_0
    iget-object v1, v0, Lj$/util/stream/A1;->a:Lj$/util/stream/L0;
    ...
    invoke-virtual {v0}, Lj$/util/stream/A1;->a()V
    ...
    :goto_1
    iget-object v3, v0, Lj$/util/stream/A1;->a:Lj$/util/stream/L0;
    ...
    invoke-virtual {v0, v1, v3}, Lj$/util/stream/A1;->b(II)Lj$/util/stream/A1;

    move-result-object v3

    int-to-long v4, v2

    iget-object v2, v3, Lj$/util/stream/A1;->a:Lj$/util/stream/L0;
