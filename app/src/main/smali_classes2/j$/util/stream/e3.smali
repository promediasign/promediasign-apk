...
.method static constructor <clinit>()V
    ...
    invoke-static {v6}, Lj$/util/stream/e3;->A(Lj$/util/stream/d3;)Lj$/util/stream/c3;
    ...
    .line 0
    iget-object v11, v7, Lj$/util/stream/c3;->a:Ljava/util/Map;
    ...
    .line 0
    iget-object v12, v10, Lj$/util/stream/c3;->a:Ljava/util/Map;
    ...
    .line 0
    iget-object v13, v11, Lj$/util/stream/c3;->a:Ljava/util/Map;
    ...
    .line 0
    iget-object v1, v13, Lj$/util/stream/c3;->a:Ljava/util/Map;
    ...
    invoke-static {v9}, Lj$/util/stream/e3;->A(Lj$/util/stream/d3;)Lj$/util/stream/c3;
    ...
    invoke-direct {v1, v3, v0, v15, v13}, Lj$/util/stream/e3;-><init>(Ljava/lang/String;IILj$/util/stream/c3;)V

    sput-object v1, Lj$/util/stream/e3;->SHORT_CIRCUIT:Lj$/util/stream/e3;

    const/4 v3, 0x5

    new-array v3, v3, [Lj$/util/stream/e3;
    ...
    sput-object v3, Lj$/util/stream/e3;->v:[Lj$/util/stream/e3;

    invoke-static {v6}, Lj$/util/stream/e3;->p(Lj$/util/stream/d3;)I

    move-result v0

    sput v0, Lj$/util/stream/e3;->f:I

    invoke-static {v8}, Lj$/util/stream/e3;->p(Lj$/util/stream/d3;)I

    move-result v0

    sput v0, Lj$/util/stream/e3;->g:I

    invoke-static {v9}, Lj$/util/stream/e3;->p(Lj$/util/stream/d3;)I

    move-result v0

    sput v0, Lj$/util/stream/e3;->h:I

    invoke-static {v12}, Lj$/util/stream/e3;->p(Lj$/util/stream/d3;)I

    invoke-static {v14}, Lj$/util/stream/e3;->p(Lj$/util/stream/d3;)I
    ...
    iget v5, v5, Lj$/util/stream/e3;->e:I
...
.method private constructor <init>(Ljava/lang/String;IILj$/util/stream/c3;)V
    ...
    :goto_0
    iget-object v2, p4, Lj$/util/stream/c3;->a:Ljava/util/Map;
    ...
    .line 0
    :cond_0
    iput-object v2, p0, Lj$/util/stream/e3;->a:Ljava/util/Map;
...
.method private static A(Lj$/util/stream/d3;)Lj$/util/stream/c3;
    .locals 3
...
.method private static p(Lj$/util/stream/d3;)I
    .locals 6
