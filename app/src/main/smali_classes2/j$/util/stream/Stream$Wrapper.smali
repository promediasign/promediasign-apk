...
.method public static synthetic convert(Lj$/util/stream/Stream;)Ljava/util/stream/Stream;
    ...
    :cond_0
    instance-of v0, p0, Lj$/util/stream/b3;

    if-eqz v0, :cond_1

    check-cast p0, Lj$/util/stream/b3;

    iget-object p0, p0, Lj$/util/stream/b3;->a:Ljava/util/stream/Stream;
...
.method public final synthetic findAny()Ljava/util/Optional;
    ...
    invoke-static {v0}, Lj$/util/d;->k(Lj$/util/Optional;)Ljava/util/Optional;
...
.method public final synthetic flatMapToDouble(Ljava/util/function/Function;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->v(Lj$/util/stream/a;)Lj$/util/stream/G;
...
.method public final synthetic flatMapToInt(Ljava/util/function/Function;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->p(Lj$/util/stream/a;)Lj$/util/stream/IntStream;
...
.method public final synthetic flatMapToLong(Ljava/util/function/Function;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->k(Lj$/util/stream/a;)Lj$/util/stream/p0;
...
.method public final synthetic mapToDouble(Ljava/util/function/ToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->mapToDouble(Ljava/util/function/ToDoubleFunction;)Lj$/util/stream/G;
...
.method public final synthetic max(Ljava/util/Comparator;)Ljava/util/Optional;
    ...
    invoke-static {p1}, Lj$/util/d;->k(Lj$/util/Optional;)Ljava/util/Optional;
